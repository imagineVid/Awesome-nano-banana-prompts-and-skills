...
> Verken ImagineVid-workflows die promptcraft omzetten in productieklare visuals.
# Awesome Nano Banana Prompts en Skills
...
> Een gecureerde collectie Nano Banana-prompts, herbruikbare promptskills en visuele voorbeelden van ImagineVid

> **Bronvermelding en verwijdering:** elke prompt linkt naar de openbare bron en maker. Rechten blijven bij de betreffende rechthebbenden. Open een issue voor correctie of verwijdering.
...
**[Blader door de Nano Banana-promptcollectie](https://imaginevid.io/nl/nano-banana)**

Waarom deze collectie gebruiken?

Productacties verwijzen naar ImagineVid; modelclaims naar officiële Google-documentatie.

| Functie | GitHub README | ImagineVid |
|---------|--------------|---------------------|
| Visuele indeling | Lineaire lijst | Gecureerde visuele secties |
| Zoeken | Alleen Ctrl+F | Gestructureerde categorieën |
| Promptworkflow | - | Herbruikbare promptskills |
| Mobiel | Basis | Leesbaar in elke README-taal |
| Categorieën | - | Bladeren op categorie |


### Bladeren op categorie

- [**Gerichte bewerking en invoercontrole**](#workflow-directed-editing-input-control) - Prompts die een bestaand beeld aanpassen of het resultaat sturen met gebieden, schetsen, referenties en positieaanwijzingen.
- [**Commercieel ontwerp, UI en posters**](#workflow-commercial-design-ui-posters) - Productiebriefings voor advertenties, productcampagnes, interfaces, posters, typografie en ander ontwerpmateriaal.
- [**Diagrammen, technische illustraties en storyboards**](#workflow-diagrams-technical-storyboards) - Gestructureerde beelden waarbij de informatievolgorde telt, zoals diagrammen, technische tekeningen en storyboards.
- [**Personages, film en visuele stijlen**](#workflow-characters-cinema-visual-styles) - Prompts voor personages, portretten, mode, filmische kaders en stijlexperimenten met duidelijke visuele regie.
- [**Omgevingen, architectuur en wereldbouw**](#workflow-environments-architecture-worldbuilding) - Prompts voor omgevingen, architectuur, landschappen, concept art en wereldbouw waarin de plek het idee draagt.
- [**Benchmarks en modelvergelijkingen**](#workflow-benchmarks-model-comparisons) - Gecontroleerde tests voor prompttrouw, bewerkingsgedrag, consistentie, typografie en visuele kwaliteit.
...
- [Wat is Nano Banana?](#wat-is-nano-banana)
...
**Nano Banana** is het oorspronkelijke Gemini-beeldmodel, officieel Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Het accepteert tekst en beelden, levert tekst en beelden op en is geoptimaliseerd voor snelle productie op grote schaal en conversationele bewerking. Deze collectie neemt alleen onderbouwde prompts op met bronvermelding, visueel bewijs en herbruikbare context.

- **Native multimodale invoer** - Combineer tekstinstructies met een of meer referentiebeelden in dezelfde aanvraag
- **Genereren en bewerken** - Maak een nieuw beeld, geef een referentie een andere stijl of voer een gerichte wijziging uit in gewone taal
- **Workflow met lage latentie** - Gericht op creatief werk met groot volume waarbij snelheid en efficiëntie tellen
- **Conversationele verfijning** - Pas compositie, onderwerp, licht of stijl aan zonder de hele briefing opnieuw op te bouwen
- **Profiel van het oorspronkelijke model** - Gemini 2.5 Flash Image levert uitvoer in de 1024px-klasse en voegt SynthID toe aan gegenereerde beelden
- **Huidige positie** - Google noemt dit model de historische pionier van de Nano Banana-familie en adviseert nieuwere modellen te vergelijken voor nieuwe producties

**Onderzoeksbronnen:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/nl/nano-banana)

### Promptvariabelen opnieuw gebruiken

Sommige bronprompts bevatten variabelen tussen blokhaken, zoals `[BRAND]`, `[OBJECT]` of `[NAME]`. Vervang alleen die waarden en behoud de beproefde beeldstructuur.

**Voorbeeld:**
```
Vervang `[BRAND]` door je merk of `[OBJECT]` door het gewenste onderwerp; laat compositie, licht en materiaal ongewijzigd.
```

Variabelen maken een prompt met verifieerbare bron herbruikbaar zonder de hele briefing opnieuw te schrijven.
...
| Totaal prompts | **42** |
| Uitgelicht | **9** |
| Laatst bijgewerkt | **donderdag 10 september 2026 om 18:49:19 UTC** |
...
> Geselecteerd op herbruikbare structuur, visuele helderheid en creatieve variatie

<a id="prompt-1"></a>

### No. 1: Zwitsers geometrisch reliëflogo
...
Vormt een merkbeeld om tot een gecentreerd monochroom reliëf met een vloeibare glasrand en beheerste Zwitserse witruimte.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Zwitsers geometrisch reliëflogo - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/AmirMushich/status/1995542490049290680)
...
### No. 2: Tastbaar lakzegel voor een merk
...
Geeft het aangeleverde logo weer als een glanzend, onregelmatig lakzegel met reliëfafdruk en zacht productlicht.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Tastbaar lakzegel voor een merk - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [AmirMušić](https://x.com/AmirMushich)
- **Bron:** [Bron](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Modecollage voor een socialmediacampagne
...
Een artdirectionsysteem dat modefotografie, knipsels, typografie en gecontroleerde visuele drukte samenbrengt.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Modecollage voor een socialmediacampagne - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [AmirMušić](https://x.com/AmirMushich)
- **Bron:** [Bron](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Geïntegreerd sjabloon voor sociale advertenties
...
Maakt een herbruikbare advertentie waarvan merk, kop, beeldsysteem en oproep via compacte variabelen wisselen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Geïntegreerd sjabloon voor sociale advertenties - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [AmirMušić](https://x.com/AmirMushich)
- **Bron:** [Bron](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Vierdelig technisch doorsnedebord
...
Vergelijkt vier apparaten in een nauwkeurig raster met explosietekeningen, transparante doorsneden, maten en toelichting.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Vierdelig technisch doorsnedebord - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Achtdelig anime-storyboard over vriendschap
...
Plant een emotionele reeks met camera-aanwijzingen over een stil kind dat na het verlies van een papieren windmolentje vriendschap vindt.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Achtdelig anime-storyboard over vriendschap - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Achtdelig anime-storyboard over vriendschap - Image 2"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Surrealistische reuzin in Venetië
...
Maakt met geforceerd perspectief een speelse reisfoto tussen de herkenningspunten van het San Marcoplein.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Surrealistische reuzin in Venetië - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: Van referentiefoto naar verzamelfiguur
...
Verandert een personagefoto in een realistisch bureaufiguur met modelleerscherm, transparante voet en geïllustreerde verpakking.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="Van referentiefoto naar verzamelfiguur - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="Van referentiefoto naar verzamelfiguur - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="Van referentiefoto naar verzamelfiguur - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="Van referentiefoto naar verzamelfiguur - Image 4"></td>
</tr>
</table>

#### Details

- **Auteur:** [Google Gemini](https://x.com/GeminiApp)
- **Bron:** [Bron](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Redactionele productfoto van bovenaf
...
Bouwt een herbruikbare bovenaanzichtscène met natuurlijk zonlicht, beheerste negatieve ruimte en optionele rekwisieten.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Redactionele productfoto van bovenaf - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/Kerroudjm/status/1971586126248133068)
...
> Twitter/X-sourced community prompt cases, gesorteerd op publicatiedatum en redactionele volgorde.

<a id="workflow-directed-editing-input-control"></a>

### Gerichte bewerking en invoercontrole (11)

Prompts die een bestaand beeld aanpassen of het resultaat sturen met gebieden, schetsen, referenties en positieaanwijzingen.

**Community · Uitgelichte prompts**

- [Van referentiefoto naar verzamelfiguur](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Een oude foto herstellen en inkleuren
...
Herstelt krassen, scheuren en verkleuring zonder personen, licht en sfeer van de bronfoto aan te tasten.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Een oude foto herstellen en inkleuren - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Een oude foto herstellen en inkleuren - Image 2"></td>
</tr>
</table>

##### Details

- **Auteur:** [WAH](https://x.com/Waheeb33)
- **Bron:** [Bron](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Reliëfposter als eerbetoon aan Frankrijk
...
Combineert een profielportret, Parijse herkenningspunten, vlagkleuren en reliëfletters in een sculpturale affiche.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Reliëfposter als eerbetoon aan Frankrijk - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Smiling Khan](https://x.com/AIwithkhan)
- **Bron:** [Bron](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Neo-noir sciencefictionportret met veel negatieve ruimte
...
Gebruikt een gezichtsreferentie voor een ingetogen portret vanuit een laag standpunt onder een uitgestrekte bewolkte hemel.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Neo-noir sciencefictionportret met veel negatieve ruimte - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
#### No. 4: Stoer outdoor-lifestyleportret
...
Plaatst het referentiegezicht in een natuurlijk belichte editorial met technische kleding en een onscherpe klassieke terreinwagen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Stoer outdoor-lifestyleportret - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Gepubliceerd:** 12 juli 2026
- **Talen:** en
...
#### No. 5: Spiegelselfie met lagen krabbels
...
Plaatst het referentiepersonage in een lichte slaapkamer en voegt handschrift, speelse pictogrammen en een lichtcontour toe.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Spiegelselfie met lagen krabbels - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Smiling Khan](https://x.com/AIwithkhan)
- **Bron:** [Bron](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: Object valt uiteen in LEGO-stenen
...
Bevriest een alledaags object halverwege de overgang naar zwevende LEGO-stenen, met behoud van kleur en textuur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Object valt uiteen in LEGO-stenen - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [AmirMušić](https://x.com/AmirMushich)
- **Bron:** [Bron](https://x.com/AmirMushich/status/1969076111628734881)
...
#### No. 7: Geborduurde transformatie met behoud van de referentie
...
Verander een geüploade foto in tastbaar borduurwerk van museumkwaliteit, met behoud van compositie, identiteiten, pose en een kleine voor-en-naweergave.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Geborduurde transformatie met behoud van de referentie - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Smiling Khan](https://x.com/AIwithkhan)
- **Bron:** [Bron](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Nieuwe case: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Nieuwe case: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Bron:** [Bron](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Auteur:** [Minahil](https://x.com/Minahil42298354)
- **Bron:** [Bron](https://x.com/Minahil42298354/status/2082038544730612074)
- **Gepubliceerd:** 28 juli 2026
- **Talen:** en
...
### Commercieel ontwerp, UI en posters (8)

Productiebriefings voor advertenties, productcampagnes, interfaces, posters, typografie en ander ontwerpmateriaal.

**Community · Uitgelichte prompts**

- [Zwitsers geometrisch reliëflogo](#prompt-1)
- [Tastbaar lakzegel voor een merk](#prompt-2)
- [Modecollage voor een socialmediacampagne](#prompt-3)
- [Geïntegreerd sjabloon voor sociale advertenties](#prompt-4)
- [Redactionele productfoto van bovenaf](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: High-fashion tenniscampagne

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Maakt een minimalistische sporteditorial met een enorme racket, spiegelende studiovloer en monumentale achtergrondletters.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="High-fashion tenniscampagne - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Smiling Khan](https://x.com/AIwithkhan)
- **Bron:** [Bron](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Donker chromen logo in een witte leegte

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Rendert het exacte merkbeeld als zwaar gepolijst metaal met microkrassen, randgloed, kleine scherptediepte en filmkorrel.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Donker chromen logo in een witte leegte - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [AmirMušić](https://x.com/AmirMushich)
- **Bron:** [Bron](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Luxe basketballeditorial als drieluik

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Bouw een campagne in drie panelen met zelfverzekerde poses, een spiegelende sportvloer, een dieprood decor en zorgvuldig geregisseerde motivatietypografie.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Luxe basketballeditorial als drieluik - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Smiling Khan](https://x.com/AIwithkhan)
- **Bron:** [Bron](https://x.com/AIwithkhan/status/2077390591777022413)
...
### Diagrammen, technische illustraties en storyboards (7)

Gestructureerde beelden waarbij de informatievolgorde telt, zoals diagrammen, technische tekeningen en storyboards.

**Community · Uitgelichte prompts**

- [Vierdelig technisch doorsnedebord](#prompt-17)
- [Achtdelig anime-storyboard over vriendschap](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Sciencefictiondiorama in een open boek

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Ordent vier sciencefictiononderwerpen als een 2×2-encyclopediespread met speelgoedachtige diorama's en modelbladdetails.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Sciencefictiondiorama in een open boek - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/Gdgtify/status/2076749503290351717)
- **Gepubliceerd:** 13 juli 2026
- **Talen:** en
...
#### No. 15: Draaiblad van een geharde held

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Een compact filmisch karakterblad met dezelfde figuur van voren, opzij en van achteren.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Draaiblad van een geharde held - Image 1"></td>
</tr>
</table>

##### Details

- **Auteur:** [Gowtham](https://x.com/GowthamCinemas)
- **Bron:** [Bron](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Technische infographic van een luxe cruiseschip

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Presenteert een fictief schip met dekdoorsneden, specificaties, interieurhoogtepunten en prestatiemeters.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Technische infographic van een luxe cruiseschip - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Minahil](https://x.com/Minahil42298354)
- **Bron:** [Bron](https://x.com/Minahil42298354/status/2052972122432016547)
- **Gepubliceerd:** 9 mei 2026
- **Talen:** en
...
#### No. 17: Geïllustreerde reiskaarten met culturele toelichting

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Bouwt rijke landkaarten met miniatuurbezienswaardigheden, lokaal eten, dieren, statistieken en tweetalige labels.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Geïllustreerde reiskaarten met culturele toelichting - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Geïllustreerde reiskaarten met culturele toelichting - Image 2"></td>
</tr>
</table>
...
- **Auteur:** [Minahil](https://x.com/Minahil42298354)
- **Bron:** [Bron](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Technisch specificatieblad voor bovenkleding

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Bundelt kledingaanzichten, materiaalclose-ups, modulaire accessoires en technische gegevens op één ontwerpblad.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Technisch specificatieblad voor bovenkleding - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Minahil](https://x.com/Minahil42298354)
- **Bron:** [Bron](https://x.com/Minahil42298354/status/2059570046972670409)
...
### Personages, film en visuele stijlen (11)

Prompts voor personages, portretten, mode, filmische kaders en stijlexperimenten met duidelijke visuele regie.

<a id="prompt-13"></a>

#### No. 19: Fotorealistische futuristische mecha

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Een herbruikbaar stijlrecept dat wezens of machines omzet in metalen, filmische en realistische mecha-ontwerpen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Fotorealistische futuristische mecha - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: Indie-slaapkamerportret uit de jaren negentig

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Bootst een spontaan lo-fi beeld na met directe flits, collagewanden, filmkorrel en nostalgische indiesfeer.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Indie-slaapkamerportret uit de jaren negentig - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Indie-slaapkamerportret uit de jaren negentig - Image 2"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Monochrome avatar in Notion-stijl
...
Maakt een persoonlijk vectorportret met zelfverzekerde monolijnen en selectieve zwarte vlakken, zonder generieke pictogramlook.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Monochrome avatar in Notion-stijl - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [AmirMušić](https://x.com/AmirMushich)
- **Bron:** [Bron](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Geometrisch mozaïekportret in blauwdrukstijl

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Bouw een eigentijds portret uit in elkaar grijpende veelhoekige fragmenten, technische constructielijnen en krachtige modernistische kleurvlakken.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Geometrisch mozaïekportret in blauwdrukstijl - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Geometrisch mozaïekportret in blauwdrukstijl - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Geometrisch mozaïekportret in blauwdrukstijl - Image 3"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Monochroom modeportret met Rembrandtlicht

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Regisseer een introspectief zwart-witportret met sculpturaal Rembrandtlicht, beheerste filmkorrel en een ingetogen luxe redactionele afwerking.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Monochroom modeportret met Rembrandtlicht - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Aijaz](https://x.com/iamsofiaijaz)
- **Bron:** [Bron](https://x.com/iamsofiaijaz/status/2077233281729536050)
- **Gepubliceerd:** 15 juli 2026
- **Talen:** en
...
#### No. 24: Modescène uit dertien referentiebeelden
...
#### No. 25: Monochrome close-up met vergrendelde identiteit
...
Compact referentieportret dat kadrering, contrast, blik, korrel en haarbeweging stuurt en de identiteit bewaart.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Monochrome close-up met vergrendelde identiteit - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Nieuwe case: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Nieuwe case: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 29: Beschermde tekstzone voor een onbelemmerde redactionele kop

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Een brononderbouwde Nano Banana-layoutworkflow die ruimte voor de kop beschermt, het onderwerp van de typografie scheidt en elk woord leesbaar houdt.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Beschermde tekstzone voor een onbelemmerde redactionele kop - Image 1"></td>
</tr>
</table>

##### Details

- **Auteur:** [Tim Start](https://x.com/timstartai)
- **Bron:** [Bron](https://x.com/timstartai/status/2084054142671266137)
...
Prompts voor omgevingen, architectuur, landschappen, concept art en wereldbouw waarin de plek het idee draagt.

**Community · Uitgelichte prompts**

- [Surrealistische reuzin in Venetië](#prompt-21)

<a id="prompt-20"></a>

#### No. 30: Bergweide tijdens het gouden uur

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Bouwt een gelaagd landschap met slingerpad, wilde bloemen, een solitaire boom, verre dieren en gloeiende bergen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Bergweide tijdens het gouden uur - Image 1"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/nxnusratul/status/2070499219476230359)
- **Gepubliceerd:** 26 juni 2026
- **Talen:** en
...
#### No. 31: Nieuwe case: Battle 🥊 4 Models 1 Models In Image Order
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Nieuwe case: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Nieuwe case: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Nieuwe case: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Nieuwe case: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Gepubliceerd:** 27 juli 2026
- **Talen:** en
...
### Benchmarks en modelvergelijkingen (2)

Gecontroleerde tests voor prompttrouw, bewerkingsgedrag, consistentie, typografie en visuele kwaliteit.

<a id="prompt-6"></a>

#### No. 32: Vergelijking van redactionele portretten: Gemini 2.5 en 3.1

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschrijving

Past dezelfde portretbriefing toe op Gemini 2.5 Flash Image en Gemini 3.1 Flash Image voor een eerlijke vergelijking.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Vergelijking van redactionele portretten: Gemini 2.5 en 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Vergelijking van redactionele portretten: Gemini 2.5 en 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Vergelijking van redactionele portretten: Gemini 2.5 en 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Vergelijking van redactionele portretten: Gemini 2.5 en 3.1 - Image 4"></td>
</tr>
</table>
...
- **Bron:** [Bron](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
#### No. 33: Nieuwe case: 2x2 grid, 16:9, do this for 4 famous days
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Nieuwe case: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Gadgetify](https://x.com/Gdgtify)
- **Bron:** [Bron](https://x.com/Gdgtify/status/2081286397949001917)
- **Gepubliceerd:** 26 juli 2026
- **Talen:** en
...
We verwelkomen hoogwaardige promptinzendingen via GitHub Issues.

### GitHub Issue

1. [**Nieuwe prompt indienen**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. Vul het formulier in met de promptdetails en afbeeldingen
3. Dien het formulier in en wacht op beoordeling door een beheerder
4. Na goedkeuring kan de issue met de lokale repositorygegevens worden gesynchroniseerd
5. Je prompt verschijnt nadat de README-generator is uitgevoerd

**Let op:** Inzendingen worden gestructureerd opgeslagen zodat de README consistent blijft.

Lees [CONTRIBUTING.md](docs/CONTRIBUTING.md) voor de volledige richtlijnen.

---

## Licentie

Uitgegeven onder [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
<details>
<summary>Makers uit de community (24)</summary>
...
**[Star-geschiedenis](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[Bekijk de gecureerde collectie](https://imaginevid.io/nl/nano-banana)** •
...
<sub>Deze README is automatisch gegenereerd. Laatst bijgewerkt: 2026-09-10T18:49:19.121Z</sub>
