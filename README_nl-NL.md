...
### Argumenten voor promptskills

Sommige prompts ondersteunen dynamische plaatshouders in Raycast Snippets-notatie, zoals `{argument ...}`. Let op het Raycast Friendly-label.

**Voorbeeld:**
```
Een filmische poster voor "{argument name="product" default="een glazen AI-camera"}" met {argument name="mood" default="nachtelijke studioverlichting"}
```

Vervang de argumenten om de prompt als compacte creatieve skill te hergebruiken.
...
| Totaal prompts | **27** |
| Uitgelicht | **9** |
| Laatst bijgewerkt | **dinsdag 14 juli 2026 om 06:04:06 UTC** |
...
<sub>Deze README is automatisch gegenereerd. Laatst bijgewerkt: 2026-07-14T06:04:06.910Z</sub>
