...
> Poznaj workflowy ImagineVid, które zmieniają pracę z promptami w wizualizacje gotowe do produkcji.
# Awesome Nano Banana Prompty i Skille
...
> Wyselekcjonowana kolekcja promptów Nano Banana, wielorazowych skilli promptowych i przykładów wizualnych od ImagineVid

> **Autorstwo i usuwanie:** każdy prompt prowadzi do publicznego źródła i twórcy. Prawa pozostają przy ich właścicielach. Otwórz issue, aby poprosić o korektę lub usunięcie.
...
**[Przeglądaj kolekcję promptów Nano Banana](https://imaginevid.io/pl/nano-banana)**

Dlaczego warto używać tej kolekcji?

Działania produktowe prowadzą do ImagineVid, a informacje o modelu opierają się na oficjalnej dokumentacji Google.

| Funkcja | GitHub README | ImagineVid |
|---------|--------------|---------------------|
| Układ wizualny | Lista liniowa | Wyselekcjonowane sekcje wizualne |
| Wyszukiwanie | Tylko Ctrl+F | Uporządkowane kategorie |
| Workflow promptu | - | Skille promptowe do ponownego użycia |
| Urządzenia mobilne | Podstawowa obsługa | Czytelne w każdej wersji językowej README |
| Kategorie | - | Przeglądanie kategorii |


### Przeglądaj według kategorii

- [**Ukierunkowana edycja i kontrola danych wejściowych**](#workflow-directed-editing-input-control) - Prompty do modyfikowania istniejących obrazów i sterowania wynikiem za pomocą obszarów, szkiców, referencji oraz położenia.
- [**Projekty komercyjne, UI i plakaty**](#workflow-commercial-design-ui-posters) - Briefy produkcyjne dla reklam, kampanii produktowych, interfejsów, plakatów, typografii i innych materiałów projektowych.
- [**Diagramy, grafika techniczna i storyboardy**](#workflow-diagrams-technical-storyboards) - Uporządkowane wizualizacje, w których liczy się kolejność informacji: diagramy, rysunki techniczne, sekwencje i storyboardy.
- [**Postacie, kino i style wizualne**](#workflow-characters-cinema-visual-styles) - Prompty do postaci, portretów, mody, kadrów filmowych i poszukiwania stylu opartego na świadomej reżyserii wizualnej.
- [**Otoczenie, architektura i budowanie światów**](#workflow-environments-architecture-worldbuilding) - Prompty do otoczenia, architektury, krajobrazu, concept artu i budowania światów, w których miejsce niesie pomysł.
- [**Testy porównawcze i porównania modeli**](#workflow-benchmarks-model-comparisons) - Kontrolowane testy zgodności z promptem, edycji, spójności, typografii i jakości wizualnej.

---

## Spis treści

- [Zobacz wybraną kolekcję](#zobacz-wybraną-kolekcję)
- [Czym jest Nano Banana?](#czym-jest-nano-banana)
...
**Nano Banana** to oryginalny model obrazowy Gemini, oficjalnie Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Przyjmuje tekst i obrazy, zwraca tekst i obrazy oraz jest zoptymalizowany pod kątem szybkiego generowania na dużą skalę i edycji konwersacyjnej. Kolekcja przyjmuje tylko prompty z potwierdzonym autorstwem, materiałem wizualnym i kontekstem do ponownego użycia.

- **Natywne wejście multimodalne** - Łącz instrukcje tekstowe z jednym lub wieloma obrazami referencyjnymi w jednym żądaniu
- **Generowanie i edycja** - Twórz nowe obrazy, zmieniaj styl referencji lub wprowadzaj konkretne zmiany językiem naturalnym
- **Przepływ o niskich opóźnieniach** - Przeznaczony do kreatywnej pracy na dużą skalę, gdzie liczą się szybkość i wydajność
- **Konwersacyjne dopracowanie** - Zmieniaj kompozycję, temat, światło i styl bez ponownego budowania całego briefu
- **Profil pierwotnego modelu** - Gemini 2.5 Flash Image generuje wyniki klasy 1024 px i dodaje SynthID do utworzonych obrazów
- **Obecne pozycjonowanie** - Google określa go jako historycznego pioniera rodziny Nano Banana i zaleca ocenę nowszych modeli przy nowych wdrożeniach

**Źródła badawcze:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/pl/nano-banana)

### Ponowne użycie zmiennych promptu

Niektóre prompty źródłowe zawierają zmienne w nawiasach, takie jak `[BRAND]`, `[OBJECT]` lub `[NAME]`. Zmieniaj tylko wartości i zachowuj sprawdzoną strukturę wizualną.

**Przykład:**
```
Zastąp `[BRAND]` własną marką lub `[OBJECT]` wybranym obiektem, pozostawiając kompozycję, światło i materiały bez zmian.
```

Zmienne pozwalają używać promptu z potwierdzonym źródłem bez pisania całego briefu od początku.
...
| Łącznie promptów | **42** |
| Polecane | **9** |
| Ostatnia aktualizacja | **poniedziałek, 17 sierpnia 2026 00:40:06 UTC** |
...
> Wybrane ze względu na strukturę do ponownego użycia, czytelność wizualną i różnorodność

<a id="prompt-1"></a>

### No. 1: Szwajcarskie geometryczne logo z tłoczeniem
...
Przekształca znak w wyśrodkowany monochromatyczny relief ze szklaną krawędzią i oszczędnym szwajcarskim światłem.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Szwajcarskie geometryczne logo z tłoczeniem - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/1995542490049290680)
...
### No. 2: Fakturowa pieczęć woskowa marki
...
Przedstawia logo jako błyszczącą, nieregularną pieczęć z wypukłym odciskiem i miękkim światłem produktowym.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Fakturowa pieczęć woskowa marki - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Kolaż modowy do kampanii społecznościowej
...
System kierunku artystycznego łączący fotografię mody, wycinki, typografię i kontrolowany wizualny nieład.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Kolaż modowy do kampanii społecznościowej - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Zintegrowany szablon reklamy społecznościowej
...
Tworzy reklamę wielokrotnego użytku, w której marka, nagłówek, system wizualny i wezwanie zmieniają się przez proste zmienne.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Zintegrowany szablon reklamy społecznościowej - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Czteropanelowa plansza przekrojów inżynierskich
...
Porównuje cztery urządzenia w precyzyjnej siatce z widokami rozstrzelonymi, przekrojami, wymiarami i opisami.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Czteropanelowa plansza przekrojów inżynierskich - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Ośmiokadrowy storyboard anime o przyjaźni
...
Planuje emocjonalną sekwencję z instrukcjami kamery o milczącym dziecku, które po utracie papierowego wiatraczka znajduje przyjaźń.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Ośmiokadrowy storyboard anime o przyjaźni - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Ośmiokadrowy storyboard anime o przyjaźni - Image 2"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Surrealistyczna olbrzymka w Wenecji
...
Za pomocą wymuszonej perspektywy tworzy zabawną fotografię podróżniczą wśród zabytków placu św. Marka.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Surrealistyczna olbrzymka w Wenecji - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: Od zdjęcia referencyjnego do figurki kolekcjonerskiej
...
Zmienia zdjęcie postaci w realistyczną figurkę biurkową z ekranem modelowania, przezroczystą podstawką i ilustrowanym pudełkiem.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="Od zdjęcia referencyjnego do figurki kolekcjonerskiej - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="Od zdjęcia referencyjnego do figurki kolekcjonerskiej - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="Od zdjęcia referencyjnego do figurki kolekcjonerskiej - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="Od zdjęcia referencyjnego do figurki kolekcjonerskiej - Image 4"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Redakcyjne zdjęcie produktu z góry
...
Tworzy wielorazową scenę z naturalnym światłem, kontrolowaną pustą przestrzenią i opcjonalnymi dodatkami.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Redakcyjne zdjęcie produktu z góry - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/Kerroudjm/status/1971586126248133068)
...
> Twitter/X-sourced community prompt cases, sortowanie według daty publikacji i kolejności redakcyjnej.

<a id="workflow-directed-editing-input-control"></a>

### Ukierunkowana edycja i kontrola danych wejściowych (11)

Prompty do modyfikowania istniejących obrazów i sterowania wynikiem za pomocą obszarów, szkiców, referencji oraz położenia.

**Community · Polecane prompty**

- [Od zdjęcia referencyjnego do figurki kolekcjonerskiej](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Renowacja i koloryzacja starej fotografii
...
Usuwa rysy, rozdarcia i wyblaknięcie, zachowując osoby, światło i atmosferę zdjęcia źródłowego.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Renowacja i koloryzacja starej fotografii - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Renowacja i koloryzacja starej fotografii - Image 2"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Reliefowy plakat w hołdzie Francji
...
Łączy portret z profilu, paryskie zabytki, barwy flagi i tłoczony tytuł w rzeźbiarskiej kompozycji.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Reliefowy plakat w hołdzie Francji - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Źródło:** [Źródło](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Neonoirowy portret science fiction z dużą przestrzenią negatywną
...
Wykorzystuje referencję twarzy do oszczędnego portretu z niskiej perspektywy pod rozległym zachmurzonym niebem.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Neonoirowy portret science fiction z dużą przestrzenią negatywną - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
Umieszcza referencyjną twarz w naturalnie oświetlonej scenie redakcyjnej z odzieżą techniczną i rozmytym klasycznym autem terenowym.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Surowy portret plenerowy - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Opublikowano:** 12 lipca 2026
- **Języki:** en
...
#### No. 5: Lustrzane selfie z warstwami rysunków
...
Umieszcza referencyjną postać w jasnej sypialni i dodaje odręczne notatki, ikony oraz świetlisty kontur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Lustrzane selfie z warstwami rysunków - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Źródło:** [Źródło](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: Przedmiot rozpadający się na klocki LEGO
...
Zatrzymuje przedmiot w połowie przemiany w unoszące się klocki LEGO, zachowując jego kolory i faktury.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Przedmiot rozpadający się na klocki LEGO - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/1969076111628734881)
...
#### No. 7: Haftowana transformacja zachowująca układ referencji
...
Przekształć przesłane zdjęcie w dotykowe dzieło haftowane o jakości muzealnej, zachowując kompozycję, tożsamość postaci, pozę i małą wstawkę przed i po.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Haftowana transformacja zachowująca układ referencji - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Źródło:** [Źródło](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Nowy przypadek: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Nowy przypadek: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Źródło:** [Źródło](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Źródło:** [Źródło](https://x.com/Minahil42298354/status/2082038544730612074)
- **Opublikowano:** 28 lipca 2026
- **Języki:** en
...
### Projekty komercyjne, UI i plakaty (8)

Briefy produkcyjne dla reklam, kampanii produktowych, interfejsów, plakatów, typografii i innych materiałów projektowych.

**Community · Polecane prompty**

- [Szwajcarskie geometryczne logo z tłoczeniem](#prompt-1)
- [Fakturowa pieczęć woskowa marki](#prompt-2)
- [Kolaż modowy do kampanii społecznościowej](#prompt-3)
- [Zintegrowany szablon reklamy społecznościowej](#prompt-4)
- [Redakcyjne zdjęcie produktu z góry](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: Tenisowa kampania wysokiej mody

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Tworzy minimalistyczny edytorial sportowy z ogromną rakietą, lustrzaną podłogą i monumentalnym tekstem w tle.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="Tenisowa kampania wysokiej mody - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Źródło:** [Źródło](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Ciemne chromowane logo w białej przestrzeni

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Renderuje dokładny znak jako ciężki polerowany metal z mikrorysami, poświatą krawędzi, małą głębią ostrości i ziarnem.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Ciemne chromowane logo w białej przestrzeni - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Luksusowy koszykarski tryptyk redakcyjny

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Zbuduj trzyczęściową kampanię z pewnymi pozami zawodniczki, odbijającym parkietem, karmazynową scenografią i precyzyjnie prowadzoną typografią motywacyjną.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Luksusowy koszykarski tryptyk redakcyjny - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Źródło:** [Źródło](https://x.com/AIwithkhan/status/2077390591777022413)
...
### Diagramy, grafika techniczna i storyboardy (7)

Uporządkowane wizualizacje, w których liczy się kolejność informacji: diagramy, rysunki techniczne, sekwencje i storyboardy.

**Community · Polecane prompty**

- [Czteropanelowa plansza przekrojów inżynierskich](#prompt-17)
- [Ośmiokadrowy storyboard anime o przyjaźni](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Diorama science fiction w otwartej książce

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Układa cztery tematy w rozkładówkę 2×2 z zabawkowymi dioramami i detalami karty modelowej.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Diorama science fiction w otwartej książce - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/Gdgtify/status/2076749503290351717)
- **Opublikowano:** 13 lipca 2026
- **Języki:** en
...
#### No. 15: Karta obrotowa zahartowanego bohatera

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Zwarta filmowa karta pokazująca tę samą postać z przodu, z boku i z tyłu.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Karta obrotowa zahartowanego bohatera - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Infografika techniczna luksusowego wycieczkowca

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Przedstawia fikcyjny statek za pomocą przekrojów pokładów, danych, wnętrz i wskaźników osiągów.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Infografika techniczna luksusowego wycieczkowca - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Źródło:** [Źródło](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: Ilustrowane mapy podróżnicze z opisami kultury

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Buduje bogate mapy państw z miniaturowymi zabytkami, kuchnią, fauną, statystykami i dwujęzycznymi podpisami.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Ilustrowane mapy podróżnicze z opisami kultury - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Ilustrowane mapy podróżnicze z opisami kultury - Image 2"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Źródło:** [Źródło](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Karta techniczna odzieży wierzchniej

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Łączy widoki ubrania, zbliżenia materiałów, modułowe dodatki i parametry na kompletnej planszy projektowej.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Karta techniczna odzieży wierzchniej - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Źródło:** [Źródło](https://x.com/Minahil42298354/status/2059570046972670409)
...
#### No. 19: Fotorealistyczny futurystyczny mecha

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Wielorazowy przepis stylistyczny przekształcający stworzenia lub maszyny w metaliczne i filmowe projekty mecha.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Fotorealistyczny futurystyczny mecha - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: Indie portret w sypialni z lat dziewięćdziesiątych

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Odtwarza swobodne zdjęcie lo-fi z bezpośrednim fleszem, ścianami w kolażach, ziarnem i nostalgicznym klimatem.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Indie portret w sypialni z lat dziewięćdziesiątych - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Indie portret w sypialni z lat dziewięćdziesiątych - Image 2"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Monochromatyczny awatar w stylu Notion
...
Tworzy osobisty portret wektorowy pewną linią o stałej grubości i selektywnymi czarnymi wypełnieniami.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Monochromatyczny awatar w stylu Notion - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Źródło:** [Źródło](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Geometryczny portret mozaikowy w stylu projektu technicznego

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Zbuduj współczesny portret z zazębiających się wielokątnych fragmentów, technicznych linii konstrukcyjnych i odważnych modernistycznych pól koloru.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Geometryczny portret mozaikowy w stylu projektu technicznego - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Geometryczny portret mozaikowy w stylu projektu technicznego - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Geometryczny portret mozaikowy w stylu projektu technicznego - Image 3"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Monochromatyczny portret modowy w świetle Rembrandta

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Wyreżyseruj introspekcyjny czarno-biały portret z rzeźbiarskim światłem Rembrandta, kontrolowanym ziarnem i oszczędnym luksusowym wykończeniem.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Monochromatyczny portret modowy w świetle Rembrandta - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Aijaz](https://x.com/iamsofiaijaz)
- **Źródło:** [Źródło](https://x.com/iamsofiaijaz/status/2077233281729536050)
- **Opublikowano:** 15 lipca 2026
- **Języki:** en
...
#### No. 24: Scena modowa z trzynastu obrazów referencyjnych
...
Test wielu referencji łączący modelkę, samochód, ubrania, dodatki, zwierzęta i rekwizyty w spójne zdjęcie studyjne.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="Scena modowa z trzynastu obrazów referencyjnych - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/MrDavids1/status/1960783672665128970)
...
#### No. 25: Monochromatyczne zbliżenie z zachowaniem tożsamości
...
Zwięzły portret referencyjny kontrolujący kadr, kontrast, spojrzenie, ziarno i włosy przy zachowaniu tożsamości.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Monochromatyczne zbliżenie z zachowaniem tożsamości - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Nowy przypadek: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Nowy przypadek: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 28: Portret streetwear w kropki

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Opis

Oparty na źródle portret modowy dla Nano Banana, który zachowuje spójność geometrii stroju, ułożenia dłoni, skali dodatków i naturalnego światła dziennego w kadrze całej sylwetki.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Portret streetwear w kropki - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Portret streetwear w kropki - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Portret streetwear w kropki - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Portret streetwear w kropki - Image 4"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/woleswoosh/status/2084247918882791849)
- **Opublikowano:** 3 sierpnia 2026
- **Języki:** en
...
Prompty do otoczenia, architektury, krajobrazu, concept artu i budowania światów, w których miejsce niesie pomysł.

**Community · Polecane prompty**

- [Surrealistyczna olbrzymka w Wenecji](#prompt-21)
...
Buduje warstwowy krajobraz z krętą ścieżką, polnymi kwiatami, samotnym drzewem, odległymi zwierzętami i świetlistymi górami.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Górska łąka o złotej godzinie - Image 1"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/nxnusratul/status/2070499219476230359)
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Nowy przypadek: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Nowy przypadek: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Nowy przypadek: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Nowy przypadek: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Opublikowano:** 27 lipca 2026
- **Języki:** en
...
### Testy porównawcze i porównania modeli (2)

Kontrolowane testy zgodności z promptem, edycji, spójności, typografii i jakości wizualnej.
...
Stosuje ten sam brief w Gemini 2.5 Flash Image i Gemini 3.1 Flash Image, aby porównać wyniki.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Porównanie portretu redakcyjnego Gemini 2.5 i 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Porównanie portretu redakcyjnego Gemini 2.5 i 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Porównanie portretu redakcyjnego Gemini 2.5 i 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Porównanie portretu redakcyjnego Gemini 2.5 i 3.1 - Image 4"></td>
</tr>
</table>
...
- **Źródło:** [Źródło](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Nowy przypadek: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Gadgetify](https://x.com/Gdgtify)
- **Źródło:** [Źródło](https://x.com/Gdgtify/status/2081286397949001917)
- **Opublikowano:** 26 lipca 2026
- **Języki:** en
...
Zapraszamy do zgłaszania wysokiej jakości promptów przez GitHub Issues.

### GitHub Issue

1. [**Zgłoś nowy prompt**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. Uzupełnij formularz o szczegóły promptu i obrazy
3. Wyślij zgłoszenie i poczekaj na weryfikację opiekuna
4. Po akceptacji issue może zostać zsynchronizowane z lokalnymi danymi repozytorium
5. Prompt pojawi się po uruchomieniu generatora README

**Uwaga:** Zgłoszenia przechowujemy w ustrukturyzowanej formie, aby README zachował spójność.

Szczegółowe zasady znajdziesz w [CONTRIBUTING.md](docs/CONTRIBUTING.md).

---

## Licencja

Udostępniono na licencji [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
**[Historia gwiazdek](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[Zobacz wybraną kolekcję](https://imaginevid.io/pl/nano-banana)** •
...
<sub>Ten README został wygenerowany automatycznie. Ostatnia aktualizacja: 2026-08-17T00:40:06.796Z</sub>
