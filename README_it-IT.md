...
> Esplora i workflow ImagineVid per trasformare i prompt in visual pronti per la produzione.
# Awesome Nano Banana Prompts e Skill
...
**[Vedi la collezione](https://imaginevid.io/it/nano-banana)**

Perché usare questa raccolta?

Le azioni sul prodotto portano a ImagineVid; le capacità del modello rimandano alla documentazione ufficiale Google.

| Funzione | GitHub README | ImagineVid |
|---------|--------------|---------------------|
| Layout visivo | Riferimento ordinato per fonte | Esplorazione visiva per categorie |
| Cerca | Ricerca nel repository | Navigazione editoriale strutturata |
| Workflow prompt | - | Prompt riutilizzabili con variabili |
| Dispositivi mobili | Markdown nativo | Leggibile in ogni versione linguistica |
| Categorie | - | Sfoglia per categoria |


### Sfoglia per categoria

- [**Modifica mirata e controllo degli input**](#workflow-directed-editing-input-control) - Prompt che modificano un’immagine esistente o controllano il risultato con aree, schizzi, riferimenti e indicazioni di posizione.
- [**Design commerciale, UI e poster**](#workflow-commercial-design-ui-posters) - Brief di produzione per pubblicità, campagne prodotto, interfacce, poster, tipografia e altri materiali di design.
- [**Diagrammi, grafica tecnica e storyboard**](#workflow-diagrams-technical-storyboards) - Visual strutturati in cui conta l’ordine delle informazioni: diagrammi, disegni tecnici, sequenze e storyboard.
- [**Personaggi, cinema e stili visivi**](#workflow-characters-cinema-visual-styles) - Prompt per personaggi, ritratti, moda, inquadrature cinematografiche ed esplorazione stilistica con una chiara direzione visiva.
- [**Ambienti, architettura e worldbuilding**](#workflow-environments-architecture-worldbuilding) - Prompt per ambienti, architettura, paesaggio, concept art e worldbuilding in cui il luogo comunica l’idea.
- [**Benchmark e confronti tra modelli**](#workflow-benchmarks-model-comparisons) - Test controllati per valutare aderenza al prompt, comportamento in modifica, coerenza, tipografia e qualità visiva.
...
- [Che cos’è Nano Banana?](#che-cosè-nano-banana)
...
**Nano Banana** è il modello di immagini Gemini originale, identificato ufficialmente come Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Accetta testo e immagini, restituisce testo e immagini ed è ottimizzato per generazione rapida ad alto volume e modifica conversazionale. La raccolta accetta solo prompt documentati con attribuzione, prova visiva e contesto riutilizzabile.

- **Input multimodale nativo** - Combina istruzioni testuali con una o più immagini di riferimento nella stessa richiesta
- **Generazione e modifica** - Crea immagini, cambia stile a una reference o applica modifiche mirate in linguaggio naturale
- **Flusso a bassa latenza** - Pensato per lavori creativi ad alto volume in cui contano velocità ed efficienza
- **Perfezionamento conversazionale** - Regola composizione, soggetto, luce e stile senza riscrivere l’intero brief
- **Profilo del modello originale** - Gemini 2.5 Flash Image produce output di classe 1024 px e include SynthID nelle immagini generate
- **Posizionamento attuale** - Google lo definisce il pioniere storico della famiglia Nano Banana e consiglia di valutare modelli più recenti per nuove produzioni

**Fonti della ricerca:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/it/nano-banana)

### Riutilizzare le variabili del prompt

Alcuni prompt originali includono variabili tra parentesi quadre, come `[BRAND]`, `[OBJECT]` o `[NAME]`. Sostituisci solo quei valori e conserva la struttura visiva verificata.

**Esempio:**
```
Sostituisci `[BRAND]` con il tuo marchio oppure `[OBJECT]` con il soggetto desiderato, lasciando invariati composizione, luce e materiali.
```

Le variabili rendono riutilizzabile un prompt documentato senza riscrivere ogni volta l’intero brief.
...
| Prompt totali | **42** |
| In evidenza | **9** |
| Ultimo aggiornamento | **mercoledì 16 settembre 2026 alle ore 02:24:12 UTC** |
...
> Scelti per riutilizzabilità, chiarezza visiva e varietà creativa

<a id="prompt-1"></a>

### No. 1: Logo geometrico svizzero in rilievo
...
Trasforma un marchio in un rilievo monocromatico centrato, con bordo effetto vetro liquido e spaziatura sobria di scuola svizzera.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Logo geometrico svizzero in rilievo - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/1995542490049290680)
...
### No. 2: Sigillo di ceralacca materico
...
Rende il logo fornito come un sigillo lucido e irregolare, con impronta in rilievo e morbida luce da prodotto.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Sigillo di ceralacca materico - Image 1"></td>
</tr>
</table>
...
- **Autore:** [AmirMušić](https://x.com/AmirMushich)
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Collage moda per una campagna social
...
Un sistema di direzione artistica che unisce fotografia di moda, ritagli, tipografia e disordine visivo controllato.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Collage moda per una campagna social - Image 1"></td>
</tr>
</table>
...
- **Autore:** [AmirMušić](https://x.com/AmirMushich)
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Modello integrato per annunci social
...
Crea un annuncio riutilizzabile in cui marchio, titolo, sistema visivo e invito all’azione cambiano tramite variabili compatte.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Modello integrato per annunci social - Image 1"></td>
</tr>
</table>
...
- **Autore:** [AmirMušić](https://x.com/AmirMushich)
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Tavola ingegneristica a quattro sezioni
...
Confronta quattro dispositivi con esplosi, sezioni trasparenti, misure e annotazioni disposti in una griglia precisa.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Tavola ingegneristica a quattro sezioni - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Storyboard anime sull’amicizia in otto scene
...
Progetta una sequenza emotiva con indicazioni di ripresa su un bambino silenzioso che trova amicizia dopo aver perso una girandola.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Storyboard anime sull’amicizia in otto scene - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Storyboard anime sull’amicizia in otto scene - Image 2"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Gigantessa surreale a Venezia
...
Mette in scena, con prospettiva forzata, una giocosa fotografia di viaggio tra i monumenti di Piazza San Marco.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Gigantessa surreale a Venezia - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: Da foto di riferimento a statuetta da collezione
...
Trasforma la foto di un personaggio in una statuetta realistica da scrivania con schermata di modellazione, base trasparente e confezione illustrata.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="Da foto di riferimento a statuetta da collezione - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="Da foto di riferimento a statuetta da collezione - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="Da foto di riferimento a statuetta da collezione - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="Da foto di riferimento a statuetta da collezione - Image 4"></td>
</tr>
</table>

#### Dettagli

- **Autore:** [Google Gemini](https://x.com/GeminiApp)
- **Fonte:** [Fonte](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Fotografia editoriale di prodotto dall’alto
...
Costruisce una scena riutilizzabile con luce naturale, spazio negativo controllato ed elementi di supporto facoltativi.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Fotografia editoriale di prodotto dall’alto - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/Kerroudjm/status/1971586126248133068)
...
> Twitter/X-sourced community prompt cases, ordinati per data di pubblicazione e priorità editoriale.

<a id="workflow-directed-editing-input-control"></a>

### Modifica mirata e controllo degli input (11)

Prompt che modificano un’immagine esistente o controllano il risultato con aree, schizzi, riferimenti e indicazioni di posizione.

**Community · Prompt in evidenza**

- [Da foto di riferimento a statuetta da collezione](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Restauro e colorazione di una vecchia fotografia
...
Ripara graffi, strappi e scolorimento preservando persone, luce e atmosfera dell’immagine originale.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Restauro e colorazione di una vecchia fotografia - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Restauro e colorazione di una vecchia fotografia - Image 2"></td>
</tr>
</table>

##### Dettagli

- **Autore:** [WAH](https://x.com/Waheeb33)
- **Fonte:** [Fonte](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Poster in rilievo dedicato alla Francia
...
Combina un ritratto di profilo, monumenti parigini, colori nazionali e testo impresso in una composizione scultorea.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Poster in rilievo dedicato alla Francia - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fonte:** [Fonte](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Ritratto sci-fi neo-noir con ampio spazio negativo
...
Usa un volto di riferimento per costruire un ritratto sobrio dal basso sotto un vasto cielo coperto.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Ritratto sci-fi neo-noir con ampio spazio negativo - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
#### No. 4: Ritratto lifestyle outdoor dal carattere deciso
...
Inserisce il volto di riferimento in una scena editoriale in luce naturale, con abbigliamento tecnico e fuoristrada d’epoca sfocato.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Ritratto lifestyle outdoor dal carattere deciso - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Pubblicato:** 12 luglio 2026
- **Lingue:** en
...
#### No. 5: Selfie allo specchio con scarabocchi sovrapposti
...
Colloca il personaggio di riferimento in una camera luminosa e aggiunge note, icone giocose e un contorno luminoso.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Selfie allo specchio con scarabocchi sovrapposti - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fonte:** [Fonte](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: Oggetto che si dissolve in mattoncini LEGO
...
Blocca un oggetto a metà della trasformazione in mattoncini LEGO sospesi, conservandone colori e materiali.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Oggetto che si dissolve in mattoncini LEGO - Image 1"></td>
</tr>
</table>
...
- **Autore:** [AmirMušić](https://x.com/AmirMushich)
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/1969076111628734881)
...
#### No. 7: Trasformazione ricamata fedele all’immagine di riferimento
...
Trasforma una foto caricata in un ricamo materico di qualità museale, mantenendo composizione, identità, posa e un piccolo confronto prima-dopo.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Trasformazione ricamata fedele all’immagine di riferimento - Image 1"></td>
</tr>
</table>
...
#### No. 8: Nuovo caso: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Nuovo caso: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
### Design commerciale, UI e poster (8)

Brief di produzione per pubblicità, campagne prodotto, interfacce, poster, tipografia e altri materiali di design.

**Community · Prompt in evidenza**

- [Logo geometrico svizzero in rilievo](#prompt-1)
- [Sigillo di ceralacca materico](#prompt-2)
- [Collage moda per una campagna social](#prompt-3)
- [Modello integrato per annunci social](#prompt-4)
- [Fotografia editoriale di prodotto dall’alto](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: Campagna tennis di alta moda

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Crea un editoriale sportivo minimale con racchetta fuori scala, pavimento riflettente e tipografia monumentale sullo sfondo.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="Campagna tennis di alta moda - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fonte:** [Fonte](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Logo in cromo scuro nel vuoto bianco

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Rende il marchio come metallo pesante lucidato, con micrograffi, bagliore sui bordi, profondità ridotta e grana fotografica.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Logo in cromo scuro nel vuoto bianco - Image 1"></td>
</tr>
</table>
...
- **Autore:** [AmirMušić](https://x.com/AmirMushich)
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Trittico editoriale di basket di lusso

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Costruisci una campagna in tre pannelli con pose sicure, parquet riflettente, scena cremisi e tipografia motivazionale guidata con precisione.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Trittico editoriale di basket di lusso - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fonte:** [Fonte](https://x.com/AIwithkhan/status/2077390591777022413)
...
Visual strutturati in cui conta l’ordine delle informazioni: diagrammi, disegni tecnici, sequenze e storyboard.

**Community · Prompt in evidenza**

- [Tavola ingegneristica a quattro sezioni](#prompt-17)
- [Storyboard anime sull’amicizia in otto scene](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Diorama narrativo sci-fi in un libro aperto

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Organizza quattro soggetti di fantascienza in una doppia pagina 2×2 con diorami giocattolo e dettagli da scheda modello.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Diorama narrativo sci-fi in un libro aperto - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/Gdgtify/status/2076749503290351717)
- **Pubblicato:** 13 luglio 2026
- **Lingue:** en
...
#### No. 15: Scheda di rotazione di un eroe temprato

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Una scheda cinematografica compatta che mostra lo stesso personaggio di fronte, di lato e di schiena.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Scheda di rotazione di un eroe temprato - Image 1"></td>
</tr>
</table>

##### Dettagli

- **Autore:** [Gowtham](https://x.com/GowthamCinemas)
- **Fonte:** [Fonte](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Infografica tecnica di una nave da crociera di lusso

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Presenta una nave immaginaria con sezioni dei ponti, dati tecnici, interni in evidenza e indicatori di prestazione.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Infografica tecnica di una nave da crociera di lusso - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Minahil](https://x.com/Minahil42298354)
- **Fonte:** [Fonte](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: Mappe di viaggio illustrate con note culturali

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Costruisce mappe nazionali ricche di monumenti in miniatura, cibi locali, fauna, statistiche e didascalie bilingui.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Mappe di viaggio illustrate con note culturali - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Mappe di viaggio illustrate con note culturali - Image 2"></td>
</tr>
</table>
...
- **Autore:** [Minahil](https://x.com/Minahil42298354)
- **Fonte:** [Fonte](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Scheda tecnica di un capospalla

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Raccoglie viste del capo, dettagli dei materiali, accessori modulari e specifiche in una tavola completa di design.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Scheda tecnica di un capospalla - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Minahil](https://x.com/Minahil42298354)
- **Fonte:** [Fonte](https://x.com/Minahil42298354/status/2059570046972670409)
...
### Personaggi, cinema e stili visivi (11)
...
#### No. 19: Mecha futuristico fotorealistico

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Una ricetta visiva riutilizzabile che trasforma creature o macchine in mecha metallici, cinematografici e realistici.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Mecha futuristico fotorealistico - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: Ritratto indie in camera da letto anni Novanta

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Ricrea una foto lo-fi spontanea con flash diretto, pareti a collage, grana analogica e atmosfera indie nostalgica.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Ritratto indie in camera da letto anni Novanta - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Ritratto indie in camera da letto anni Novanta - Image 2"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Avatar monocromatico in stile Notion
...
Crea un ritratto vettoriale personale con linee uniformi sicure e campiture nere selettive, evitando l’aspetto da icona generica.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Avatar monocromatico in stile Notion - Image 1"></td>
</tr>
</table>
...
- **Autore:** [AmirMušić](https://x.com/AmirMushich)
- **Fonte:** [Fonte](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Ritratto a mosaico geometrico in stile blueprint

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Costruisci un ritratto contemporaneo con frammenti poligonali a incastro, linee tecniche di costruzione e campiture moderniste decise.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Ritratto a mosaico geometrico in stile blueprint - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Ritratto a mosaico geometrico in stile blueprint - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Ritratto a mosaico geometrico in stile blueprint - Image 3"></td>
</tr>
</table>
...
#### No. 23: Ritratto fashion monocromatico con luce Rembrandt

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Dirigi un ritratto introspettivo in bianco e nero con luce Rembrandt scultorea, grana controllata e finitura editoriale di lusso.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Ritratto fashion monocromatico con luce Rembrandt - Image 1"></td>
</tr>
</table>
...
- **Autore:** [Aijaz](https://x.com/iamsofiaijaz)
- **Fonte:** [Fonte](https://x.com/iamsofiaijaz/status/2077233281729536050)
- **Pubblicato:** 15 luglio 2026
- **Lingue:** en
...
#### No. 24: Scena fashion da tredici immagini di riferimento
...
Test multi-riferimento che unisce modella, auto, abiti, accessori, animali e oggetti in uno scatto coerente.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="Scena fashion da tredici immagini di riferimento - Image 1"></td>
</tr>
</table>

##### Dettagli

- **Autore:** [@MrDavids1](https://x.com/MrDavids1)
...
#### No. 25: Primo piano monocromatico con identità bloccata
...
Ritratto di riferimento compatto che controlla taglio, contrasto, sguardo, grana e capelli proteggendo l’identità.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Primo piano monocromatico con identità bloccata - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Nuovo caso: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Nuovo caso: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
#### No. 27: Ritratto editoriale neo-giapponese in sumi-e

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Un caso basato su fonti verificabili che esplora «Ritratto editoriale neo-giapponese in sumi-e», con istruzioni riutilizzabili e media del risultato ispezionabili.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsBrfWEAAcoeQ.jpg" width="100%" alt="Ritratto editoriale neo-giapponese in sumi-e - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsCfjW8AAjn16.jpg" width="100%" alt="Ritratto editoriale neo-giapponese in sumi-e - Image 2"></td>
</tr>
</table>
...
- **Autore:** [zayan](https://x.com/HustleXR)
- **Fonte:** [Fonte](https://x.com/HustleXR/status/2084159526719385833)
...
#### No. 29: Area di testo protetta per un titolo editoriale senza sovrapposizioni

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Un workflow di impaginazione Nano Banana documentato da una fonte, che protegge il titolo, separa il soggetto dalla tipografia e mantiene leggibile ogni parola.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Area di testo protetta per un titolo editoriale senza sovrapposizioni - Image 1"></td>
</tr>
</table>

##### Dettagli

- **Autore:** [Tim Start](https://x.com/timstartai)
- **Fonte:** [Fonte](https://x.com/timstartai/status/2084054142671266137)
...
Prompt per ambienti, architettura, paesaggio, concept art e worldbuilding in cui il luogo comunica l’idea.

**Community · Prompt in evidenza**

- [Gigantessa surreale a Venezia](#prompt-21)

<a id="prompt-20"></a>

#### No. 30: Prato di montagna nell’ora dorata

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Compone un paesaggio a strati con sentiero sinuoso, fiori selvatici, albero solitario, animali lontani e montagne luminose.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Prato di montagna nell’ora dorata - Image 1"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/nxnusratul/status/2070499219476230359)
...
#### No. 31: Nuovo caso: Battle 🥊 4 Models 1 Models In Image Order
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Nuovo caso: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Nuovo caso: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Nuovo caso: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Nuovo caso: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
### Benchmark e confronti tra modelli (2)

Test controllati per valutare aderenza al prompt, comportamento in modifica, coerenza, tipografia e qualità visiva.

<a id="prompt-6"></a>

#### No. 32: Confronto di ritratto editoriale: Gemini 2.5 e 3.1

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrizione

Applica lo stesso brief a Gemini 2.5 Flash Image e Gemini 3.1 Flash Image per confrontarne il risultato visivo.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Confronto di ritratto editoriale: Gemini 2.5 e 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Confronto di ritratto editoriale: Gemini 2.5 e 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Confronto di ritratto editoriale: Gemini 2.5 e 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Confronto di ritratto editoriale: Gemini 2.5 e 3.1 - Image 4"></td>
</tr>
</table>
...
- **Fonte:** [Fonte](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
#### No. 33: Nuovo caso: 2x2 grid, 16:9, do this for 4 famous days
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Nuovo caso: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
Hai trovato un workflow Nano Banana ben documentato? Invia prompt originale, risultato, autore e fonte tramite GitHub Issues.

### GitHub Issue

1. [**Invia un nuovo prompt**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. Compila il modulo con prompt, immagini e dati della fonte
3. Invia la proposta e attendi la verifica del maintainer
4. Dopo l’approvazione, la issue può essere sincronizzata con i dati locali
5. Il prompt apparirà dopo la successiva generazione dei README

**Nota:** Ogni proposta viene controllata per provenienza, prova del modello, utilità e duplicati prima della pubblicazione.

Consulta [CONTRIBUTING.md](docs/CONTRIBUTING.md) per le regole complete.
...
<details>
<summary>Autori della community (24)</summary>
...
**[Storico star](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**
...
<sub>README generato automaticamente. Ultimo aggiornamento: 2026-09-16T02:24:12.647Z</sub>
