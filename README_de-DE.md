...
> **Copyright-Hinweis**: Prompts werden mit Quellenangabe zu Bildungs- und Kreativreferenz gesammelt. Wenn Inhalte entfernt werden sollen, öffne bitte ein Issue.
...
### Prompt-Skill-Argumente

Einige Prompts unterstützen dynamische Platzhalter im Raycast-Snippets-Stil mit `{argument ...}`. Achte auf das Raycast-Friendly-Badge.

**Beispiel:**
```
Ein filmisches Poster für ein Produkt mit der gewünschten Stimmung
```

Ersetze die Argumente, um den Prompt als kompakten Kreativ-Skill wiederzuverwenden.
