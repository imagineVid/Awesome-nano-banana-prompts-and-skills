...
> Entdecke ImagineVid-Workflows, die Prompt-Handwerk in produktionsreife Visuals verwandeln.
# Awesome Nano Banana Prompts und Skills
...
## Kuratierte Sammlung ansehen

**[Die Nano Banana Prompt-Sammlung durchsuchen](https://imaginevid.io/de/nano-banana)**

Warum diese Sammlung nutzen?

Produktaktionen führen zu ImagineVid; Modellangaben stützen sich auf offizielle Google-Dokumentation.

| Funktion | GitHub README | ImagineVid-Sammlung |
|---------|--------------|---------------------|
| Visuelles Layout | Lineare Liste | Kuratierte visuelle Abschnitte |
| Suche | Nur Ctrl+F | Strukturierte Kategorien |
| Prompt-Workflow | - | Wiederverwendbare Prompt-Skills |
| Mobil | Basis | In jeder README-Sprache lesbar |
| Kategorien | - | Kategorie-Browsing |


### Nach Kategorie durchsuchen

- [**Gezielte Bearbeitung und Eingabesteuerung**](#workflow-directed-editing-input-control) - Prompts zum Ändern vorhandener Bilder oder zur Steuerung durch Bereiche, Skizzen, Referenzen und Positionsangaben.
- [**Kommerzielles Design, UI und Poster**](#workflow-commercial-design-ui-posters) - Produktionsbriefings für Anzeigen, Produktkampagnen, Oberflächen, Poster, Typografie und weitere Designmedien.
- [**Diagramme, technische Visuals und Storyboards**](#workflow-diagrams-technical-storyboards) - Strukturierte Visualisierungen mit klarer Informationsfolge, etwa Diagramme, technische Zeichnungen und Storyboards.
- [**Charaktere, Kino und visuelle Stile**](#workflow-characters-cinema-visual-styles) - Prompts für Figuren, Porträts, Mode, filmische Einstellungen und Stilforschung mit klarer visueller Regie.
- [**Umgebungen, Architektur und Worldbuilding**](#workflow-environments-architecture-worldbuilding) - Prompts für Umgebungen, Architektur, Landschaften, Concept Art und Weltenbau, bei denen der Ort die Idee trägt.
- [**Benchmarks und Modellvergleiche**](#workflow-benchmarks-model-comparisons) - Kontrollierte Tests für Prompttreue, Bearbeitungsverhalten, Konsistenz, Typografie und visuelle Qualität.

---

## Inhalt

- [Kuratierte Sammlung ansehen](#kuratierte-sammlung-ansehen)
- [Was ist Nano Banana?](#was-ist-nano-banana)
- [Statistiken](#statistiken)
- [Community · Ausgewählte Prompts](#community-featured-prompts)
...
**Nano Banana** ist das ursprüngliche Gemini-Bildmodell mit der offiziellen Bezeichnung Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Es verarbeitet Text und Bilder, gibt Text und Bilder aus und ist für schnelle, umfangreiche Generierung sowie dialogbasierte Bearbeitung optimiert. Diese Sammlung übernimmt nur belegte Prompts mit Urhebernennung, Mediennachweis und wiederverwendbarem Kontext.

- **Native multimodale Eingabe** - Textanweisungen und eine oder mehrere Referenzbilder lassen sich in einer Anfrage kombinieren
- **Generierung und Bearbeitung** - Neue Bilder erzeugen, Referenzen neu gestalten oder gezielte Änderungen in natürlicher Sprache ausführen
- **Workflow mit niedriger Latenz** - Für kreative Aufgaben mit hohem Volumen, bei denen Tempo und Effizienz zählen
- **Dialogbasierte Verfeinerung** - Komposition, Motiv, Licht und Stil weiterentwickeln, ohne das Briefing neu aufzubauen
- **Profil des Originalmodells** - Gemini 2.5 Flash Image erzeugt Ausgaben der 1024px-Klasse und versieht generierte Bilder mit SynthID
- **Heutige Einordnung** - Google bezeichnet es als Wegbereiter der Nano-Banana-Familie und empfiehlt für neue Produktionen den Vergleich mit neueren Modellen

**Recherchequellen:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/de/nano-banana)

### Prompt-Variablen wiederverwenden

Einige Quellen verwenden eckige Variablen wie `[BRAND]`, `[OBJECT]` oder `[NAME]`. Ersetze nur diese Werte und behalte die erprobte Bildstruktur bei.

**Beispiel:**
```
Ersetze `[BRAND]` durch deine Marke oder `[OBJECT]` durch dein Motiv; Komposition, Licht und Materialanweisungen bleiben unverändert.
```

Variablen machen einen belegten Prompt wiederverwendbar, ohne jedes Briefing von Grund auf neu zu schreiben.
...
| Prompts gesamt | **42** |
| Ausgewählt | **9** |
| Zuletzt aktualisiert | **Donnerstag, 10. September 2026 um 15:30:13 UTC** |
...
## Community · Ausgewählte Prompts

> Ausgewählt nach Wiederverwendbarkeit, visueller Klarheit und kreativer Bandbreite

<a id="prompt-1"></a>

### No. 1: Schweizer Geometrie als geprägtes Logo
...
Verwandelt ein Markenzeichen in ein zentriertes monochromes Relief mit flüssig wirkender Glaskante und ruhigem Schweizer Weißraum.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Schweizer Geometrie als geprägtes Logo - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/1995542490049290680)
...
### No. 2: Haptisches Wachssiegel für Marken
...
Setzt ein Logo als glänzendes, unregelmäßiges Wachssiegel mit erhabenem Abdruck und weichem Produktlicht um.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Haptisches Wachssiegel für Marken - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Fashion-Collage für eine Social-Kampagne
...
Ein Art-Direction-System aus Modefotografie, Collagefragmenten, Typografie und bewusst kontrollierter Unordnung.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Fashion-Collage für eine Social-Kampagne - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Integrierte Vorlage für Social Ads
...
Erstellt eine wiederverwendbare Anzeige, deren Marke, Headline, Bildsystem und CTA über kompakte Variablen austauschbar sind.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Integrierte Vorlage für Social Ads - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Vierfeldtafel mit technischen Schnittzeichnungen
...
Vergleicht vier Geräte in einem präzisen Raster mit Explosionsansichten, transparenten Schnitten, Maßen und Anmerkungen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Vierfeldtafel mit technischen Schnittzeichnungen - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Achtteiliges Anime-Storyboard über Freundschaft
...
Plant eine emotionale Bildfolge mit Kameraangaben über ein stilles Kind, das nach dem Verlust seines Windrads Freundschaft findet.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Achtteiliges Anime-Storyboard über Freundschaft - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Achtteiliges Anime-Storyboard über Freundschaft - Image 2"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Surreale Riesin in Venedig
...
Inszeniert mit erzwungener Perspektive eine spielerische Reisefotografie zwischen den Wahrzeichen des Markusplatzes.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Surreale Riesin in Venedig - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: Vom Referenzfoto zur Sammlerfigur
...
Verwandelt ein Charakterfoto in eine realistische Tischfigur mit Modellierungsbildschirm, Acrylsockel und illustrierter Verpackung.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="Vom Referenzfoto zur Sammlerfigur - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="Vom Referenzfoto zur Sammlerfigur - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="Vom Referenzfoto zur Sammlerfigur - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="Vom Referenzfoto zur Sammlerfigur - Image 4"></td>
</tr>
</table>

#### Details

- **Autor:** [Google Gemini](https://x.com/GeminiApp)
- **Quelle:** [Quelle](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Editoriale Produktaufnahme von oben
...
Entwirft eine wiederverwendbare Draufsicht mit natürlichem Sonnenlicht, bewusstem Freiraum und optionalen Begleitelementen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Editoriale Produktaufnahme von oben - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/Kerroudjm/status/1971586126248133068)
...
> Twitter/X-sourced community prompt cases, sortiert nach veröffentlichungsdatum und kuratierungsreihenfolge.

<a id="workflow-directed-editing-input-control"></a>

### Gezielte Bearbeitung und Eingabesteuerung (11)

Prompts zum Ändern vorhandener Bilder oder zur Steuerung durch Bereiche, Skizzen, Referenzen und Positionsangaben.

**Community · Ausgewählte Prompts**

- [Vom Referenzfoto zur Sammlerfigur](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Altes Foto restaurieren und kolorieren
...
Repariert Kratzer, Risse und Verblassung, ohne Personen, Licht und Atmosphäre der Vorlage zu verändern.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Altes Foto restaurieren und kolorieren - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Altes Foto restaurieren und kolorieren - Image 2"></td>
</tr>
</table>

##### Details

- **Autor:** [WAH](https://x.com/Waheeb33)
- **Quelle:** [Quelle](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Reliefplakat als Hommage an Frankreich
...
Verbindet Profilporträt, Pariser Wahrzeichen, Nationalfarben und geprägte Schrift zu einem skulpturalen Tribute-Poster.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Reliefplakat als Hommage an Frankreich - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Quelle:** [Quelle](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Neo-Noir-Sci-Fi-Porträt mit viel Negativraum
...
Inszeniert eine Gesichtsreferenz als zurückhaltendes Porträt aus tiefer Perspektive unter einem weiten bedeckten Himmel.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Neo-Noir-Sci-Fi-Porträt mit viel Negativraum - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
#### No. 4: Robustes Outdoor-Lifestyle-Porträt
...
Versetzt das Referenzgesicht in eine natürlich beleuchtete Editorial-Szene mit Funktionskleidung und unscharfem Vintage-Geländewagen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Robustes Outdoor-Lifestyle-Porträt - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Veröffentlicht:** 12. Juli 2026
- **Sprachen:** en
...
#### No. 5: Spiegel-Selfie mit Kritzel-Ebenen
...
Setzt die Referenzfigur in ein helles Schlafzimmer-Selfie und ergänzt Handschrift, verspielte Symbole und eine leuchtende Kontur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Spiegel-Selfie mit Kritzel-Ebenen - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Quelle:** [Quelle](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: Objekt zerfällt in LEGO-Steine
...
Friert den Moment ein, in dem ein Alltagsobjekt unter Beibehaltung seiner Farben und Texturen in schwebende LEGO-Steine übergeht.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Objekt zerfällt in LEGO-Steine - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/1969076111628734881)
...
#### No. 7: Referenzerhaltende Verwandlung in Stickkunst
...
Verwandle ein hochgeladenes Foto in eine fühlbar wirkende Stickarbeit in Museumsqualität, ohne Komposition, Identitäten, Pose und eine kleine Vorher-nachher-Referenz zu verlieren.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Referenzerhaltende Verwandlung in Stickkunst - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Quelle:** [Quelle](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Neuer Fall: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Neuer Fall: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Quelle:** [Quelle](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Quelle:** [Quelle](https://x.com/Minahil42298354/status/2082038544730612074)
- **Veröffentlicht:** 28. Juli 2026
- **Sprachen:** en
...
- [Schweizer Geometrie als geprägtes Logo](#prompt-1)
- [Haptisches Wachssiegel für Marken](#prompt-2)
- [Fashion-Collage für eine Social-Kampagne](#prompt-3)
- [Integrierte Vorlage für Social Ads](#prompt-4)
- [Editoriale Produktaufnahme von oben](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: High-Fashion-Tenniskampagne

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Gestaltet ein minimalistisches Sport-Editorial mit übergroßem Schläger, spiegelndem Studioboden und monumentaler Hintergrundschrift.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="High-Fashion-Tenniskampagne - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Quelle:** [Quelle](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Dunkles Chromlogo im weißen Raum

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Rendert das exakte Markenzeichen als schweres poliertes Metall mit Mikrokratzern, Kantenleuchten, geringer Schärfentiefe und Filmkorn.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Dunkles Chromlogo im weißen Raum - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Luxuriöses Basketball-Editorial als Triptychon
...
Strukturierte Visualisierungen mit klarer Informationsfolge, etwa Diagramme, technische Zeichnungen und Storyboards.

**Community · Ausgewählte Prompts**

- [Vierfeldtafel mit technischen Schnittzeichnungen](#prompt-17)
- [Achtteiliges Anime-Storyboard über Freundschaft](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Aufgeschlagenes Sci-Fi-Geschichtendiorama

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Ordnet vier Science-Fiction-Themen als 2×2-Enzyklopädieseite mit Spielzeugdioramen und Model-Sheet-Details an.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Aufgeschlagenes Sci-Fi-Geschichtendiorama - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/Gdgtify/status/2076749503290351717)
- **Veröffentlicht:** 13. Juli 2026
- **Sprachen:** en
...
#### No. 15: Charakteransichten eines rauen Helden

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Ein kompaktes filmisches Character Sheet mit derselben Figur von vorn, von der Seite und von hinten.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Charakteransichten eines rauen Helden - Image 1"></td>
</tr>
</table>

##### Details

- **Autor:** [Gowtham](https://x.com/GowthamCinemas)
- **Quelle:** [Quelle](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Technische Infografik eines Luxuskreuzfahrtschiffs

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Präsentiert ein fiktives Schiff mit Deckschnitten, Kennzahlen, Innenraum-Highlights und Leistungsanzeigen.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Technische Infografik eines Luxuskreuzfahrtschiffs - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Quelle:** [Quelle](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: Illustrierte Reisekarten mit Kulturhinweisen

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Erstellt detailreiche Länderkarten aus Miniaturwahrzeichen, Speisen, Tierwelt, Statistiken und zweisprachigen Beschriftungen.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Illustrierte Reisekarten mit Kulturhinweisen - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Illustrierte Reisekarten mit Kulturhinweisen - Image 2"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Quelle:** [Quelle](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Technisches Datenblatt für Outdoor-Bekleidung

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Bündelt Kleidungsansichten, Materialdetails, modulares Zubehör und technische Angaben auf einem vollständigen Designblatt.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Technisches Datenblatt für Outdoor-Bekleidung - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Quelle:** [Quelle](https://x.com/Minahil42298354/status/2059570046972670409)
...
### Charaktere, Kino und visuelle Stile (11)

Prompts für Figuren, Porträts, Mode, filmische Einstellungen und Stilforschung mit klarer visueller Regie.

<a id="prompt-13"></a>

#### No. 19: Fotorealistischer Zukunfts-Mecha

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Ein wiederverwendbares Stilrezept, das Kreaturen oder Maschinen in metallische, filmische und realistische Mecha-Entwürfe verwandelt.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Fotorealistischer Zukunfts-Mecha - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: Indie-Schlafzimmerporträt der 1990er

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Rekonstruiert ein beiläufiges Lo-Fi-Foto mit Direktblitz, Collagewänden, Filmkorn und nostalgischer Indie-Ästhetik.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Indie-Schlafzimmerporträt der 1990er - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Indie-Schlafzimmerporträt der 1990er - Image 2"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Monochromer Avatar im Notion-Stil
...
Erzeugt mit sicherer Monoline-Zeichnung und gezielten Schwarzflächen ein persönliches Vektorporträt statt eines generischen Icons.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Monochromer Avatar im Notion-Stil - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Quelle:** [Quelle](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Geometrisches Mosaikporträt im Blueprint-Stil

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Erzeuge ein zeitgenössisches Porträt aus ineinandergreifenden Polygonfragmenten, technischen Konstruktionslinien und kräftigen modernistischen Farbflächen.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Geometrisches Mosaikporträt im Blueprint-Stil - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Geometrisches Mosaikporträt im Blueprint-Stil - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Geometrisches Mosaikporträt im Blueprint-Stil - Image 3"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Monochromes Modeporträt im Rembrandt-Licht
...
#### No. 24: Modeszene aus dreizehn Referenzbildern
...
Mehrfachreferenz-Test, der Model, Auto, Kleidung, Accessoires, Tiere und Requisiten in einer stimmigen Studioaufnahme vereint.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="Modeszene aus dreizehn Referenzbildern - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/MrDavids1/status/1960783672665128970)
...
#### No. 25: Windbewegte Schwarzweiß-Nahaufnahme mit Identitätssperre
...
Kompaktes Referenzporträt mit Vorgaben für Ausschnitt, Kontrast, Blick, Korn und Haarbewegung bei geschützter Identität.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Windbewegte Schwarzweiß-Nahaufnahme mit Identitätssperre - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Neuer Fall: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Neuer Fall: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 27: Neo-japanisches Sumi-e-Editorialporträt

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Ein quellenbelegter Fall zu „Neo-japanisches Sumi-e-Editorialporträt“ mit wiederverwendbaren Anweisungen und überprüfbaren Ergebnismedien.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsBrfWEAAcoeQ.jpg" width="100%" alt="Neo-japanisches Sumi-e-Editorialporträt - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsCfjW8AAjn16.jpg" width="100%" alt="Neo-japanisches Sumi-e-Editorialporträt - Image 2"></td>
</tr>
</table>
...
- **Autor:** [zayan](https://x.com/HustleXR)
- **Quelle:** [Quelle](https://x.com/HustleXR/status/2084159526719385833)
...
#### No. 28: Streetstyle-Porträt mit Polka-Dots

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Ein quellenbasiertes Nano-Banana-Modeporträt, das Kleidungsgeometrie, Handposition, Accessoiremaßstab und natürliches Tageslicht in einer Ganzkörperaufnahme zusammenhält.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Streetstyle-Porträt mit Polka-Dots - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Streetstyle-Porträt mit Polka-Dots - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Streetstyle-Porträt mit Polka-Dots - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Streetstyle-Porträt mit Polka-Dots - Image 4"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/woleswoosh/status/2084247918882791849)
- **Veröffentlicht:** 3. August 2026
- **Sprachen:** en
...
#### No. 29: Geschützter Textbereich für eine ungestörte Editorial-Schlagzeile

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Ein quellenbasiertes Nano-Banana-Layout, das Platz für die Schlagzeile schützt, das Motiv von der Typografie trennt und jedes Wort lesbar hält.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Geschützter Textbereich für eine ungestörte Editorial-Schlagzeile - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/timstartai/status/2084054142671266137)
...
### Umgebungen, Architektur und Worldbuilding (3)

Prompts für Umgebungen, Architektur, Landschaften, Concept Art und Weltenbau, bei denen der Ort die Idee trägt.

**Community · Ausgewählte Prompts**

- [Surreale Riesin in Venedig](#prompt-21)

<a id="prompt-20"></a>

#### No. 30: Bergwiese zur goldenen Stunde

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Baut eine gestaffelte Landschaft aus gewundenem Weg, Wildblumen, Einzelbaum, ferner Tierwelt und leuchtendem Gebirge.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Bergwiese zur goldenen Stunde - Image 1"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/nxnusratul/status/2070499219476230359)
...
#### No. 31: Neuer Fall: Battle 🥊 4 Models 1 Models In Image Order
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Neuer Fall: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Neuer Fall: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Neuer Fall: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Neuer Fall: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Veröffentlicht:** 27. Juli 2026
- **Sprachen:** en
...
### Benchmarks und Modellvergleiche (2)

Kontrollierte Tests für Prompttreue, Bearbeitungsverhalten, Konsistenz, Typografie und visuelle Qualität.

<a id="prompt-6"></a>

#### No. 32: Editorial-Porträtvergleich Gemini 2.5 gegen 3.1

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Beschreibung

Vergleicht Gemini 2.5 Flash Image und Gemini 3.1 Flash Image anhand desselben kontrollierten Porträtbriefings.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Editorial-Porträtvergleich Gemini 2.5 gegen 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Editorial-Porträtvergleich Gemini 2.5 gegen 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Editorial-Porträtvergleich Gemini 2.5 gegen 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Editorial-Porträtvergleich Gemini 2.5 gegen 3.1 - Image 4"></td>
</tr>
</table>
...
- **Quelle:** [Quelle](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
#### No. 33: Neuer Fall: 2x2 grid, 16:9, do this for 4 famous days
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Neuer Fall: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Gadgetify](https://x.com/Gdgtify)
- **Quelle:** [Quelle](https://x.com/Gdgtify/status/2081286397949001917)
- **Veröffentlicht:** 26. Juli 2026
- **Sprachen:** en
...
Hochwertige Prompt-Einreichungen über GitHub Issues sind willkommen.

### GitHub Issue

1. [**Neuen Prompt einreichen**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. Formular mit Prompt-Details und Bildern ausfüllen
3. Absenden und auf Maintainer-Review warten
4. Nach Freigabe kann das Issue in lokale Daten synchronisiert werden
5. Dein Prompt erscheint nach dem README-Generierungslauf

**Hinweis:** Einreichungen bleiben strukturiert, damit das README konsistent bleibt.

Details stehen in [CONTRIBUTING.md](docs/CONTRIBUTING.md).
...
<details>
<summary>Community-Autoren (24)</summary>
...
**[Star-Verlauf](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[Kuratierte Sammlung ansehen](https://imaginevid.io/de/nano-banana)** •
...
<sub>Dieses README wird automatisch generiert. Zuletzt aktualisiert: 2026-09-10T15:30:13.097Z</sub>
