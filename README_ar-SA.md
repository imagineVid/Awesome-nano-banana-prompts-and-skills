...
# مجموعة Nano Banana الرائعة للتعليمات ومهارات الصياغة
...
> مجموعة منسقة من تعليمات Nano Banana ومهارات تعليمات قابلة لإعادة الاستخدام وأمثلة بصرية من ImagineVid

> **النسب والإزالة:** ترتبط كل تعليمة بمصدرها العلني ومنشئها، وتبقى الحقوق لأصحابها. افتح issue لطلب تصحيح المحتوى أو إزالته.
...
- [**التحرير الموجّه والتحكم في المدخلات**](#workflow-directed-editing-input-control) - تعليمات لتعديل صورة موجودة أو ضبط النتيجة باستخدام المناطق والرسومات المرجعية وتعليمات الموضع.
- [**التصميم التجاري وواجهات المستخدم والملصقات**](#workflow-commercial-design-ui-posters) - موجزات إنتاج للإعلانات وحملات المنتجات والواجهات والملصقات والطباعة وغيرها من المواد المصممة.
- [**المخططات والرسوم التقنية والقصص المصورة**](#workflow-diagrams-technical-storyboards) - مرئيات منظمة يكون فيها ترتيب المعلومات أساسياً، مثل المخططات والرسوم التقنية والتسلسلات والقصص المصورة.
- [**الشخصيات والسينما والأساليب البصرية**](#workflow-characters-cinema-visual-styles) - تعليمات للشخصيات والصور الشخصية والأزياء واللقطات السينمائية واستكشاف الأساليب وفق توجيه بصري واضح.
- [**البيئات والعمارة وبناء العوالم**](#workflow-environments-architecture-worldbuilding) - تعليمات للبيئات والعمارة والمناظر والفن التصوري وبناء العوالم حيث يحمل المكان الفكرة.
- [**الاختبارات المعيارية ومقارنات النماذج**](#workflow-benchmarks-model-comparisons) - اختبارات مضبوطة لتقييم اتباع التعليمات وسلوك التحرير والاتساق والطباعة والجودة البصرية.

---

## جدول المحتويات

- [عرض المجموعة المنسقة](#عرض-المجموعة-المنسقة)
- [ما هو Nano Banana؟](#ما-هو-nano-banana)
- [الإحصاءات](#الإحصاءات)
...
**Nano Banana** هو نموذج الصور الأصلي من Gemini، واسمه الرسمي Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). يقبل النصوص والصور ويُخرج نصوصاً وصوراً، وهو محسّن للتوليد السريع واسع النطاق والتحرير الحواري. لا تضم هذه المجموعة إلا مطالبات موثقة تحافظ على اسم المنشئ والدليل المرئي والسياق القابل لإعادة الاستخدام.

- **إدخال متعدد الوسائط أصلي** - اجمع تعليمات نصية مع صورة مرجعية واحدة أو أكثر في الطلب نفسه
- **التوليد والتحرير** - أنشئ صورة جديدة أو أعد تنسيق مرجع أو نفّذ تعديلاً محدداً بلغة طبيعية
- **سير عمل منخفض التأخير** - مخصص للإنتاج الإبداعي واسع النطاق حيث تكون السرعة والكفاءة أساسيتين
- **تحسين حواري** - عدّل التكوين والموضوع والإضاءة والأسلوب دون إعادة كتابة الموجز بالكامل
- **ملف النموذج الأصلي** - ينتج Gemini 2.5 Flash Image صوراً ضمن فئة 1024 بكسل ويضيف SynthID إلى الصور المولدة
- **الموقع الحالي** - تصفه Google الآن بأنه الرائد التاريخي لعائلة Nano Banana وتوصي بتقييم النماذج الأحدث للمشروعات الجديدة

**مصادر البحث:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/ar/nano-banana)

### إعادة استخدام متغيرات التعليمة

تتضمن بعض التعليمات المصدرية متغيرات بين قوسين مثل `[BRAND]` و`[OBJECT]` و`[NAME]`. استبدل القيم فقط وحافظ على البنية البصرية المختبرة.

**مثال:**
```
استبدل `[BRAND]` بعلامتك أو `[OBJECT]` بالعنصر المطلوب، واترك تعليمات التكوين والإضاءة والخامات كما هي.
```

تجعل المتغيرات التعليمة الموثقة قابلة لإعادة الاستخدام دون إعادة كتابة الموجز كاملاً.
...
| إجمالي التعليمات | **42** |
| مميز | **9** |
| آخر تحديث | **الأربعاء، ١٦ سبتمبر ٢٠٢٦ في ١٠:٢٩:١٠ م UTC** |
...
يحوّل العلامة إلى نقش أحادي اللون في المنتصف، بحافة زجاجية سائلة ومساحات بيضاء منضبطة على النهج السويسري.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="شعار هندسي سويسري بارز - Image 1"></td>
</tr>
</table>

#### التفاصيل

- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/1995542490049290680)
...
يعرض الشعار المرفق كختم شمعي لامع وغير منتظم، ببروز واضح وإضاءة منتجات ناعمة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="ختم شمعي ملمسي للعلامة - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: كولاج أزياء لحملة اجتماعية
...
نظام إخراج فني يجمع تصوير الأزياء والقصاصات والطباعة والفوضى البصرية المنضبطة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="كولاج أزياء لحملة اجتماعية - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/2020895358126002197)
- **تاريخ النشر:** ٩ فبراير ٢٠٢٦
- **اللغات:** en
...
### No. 4: قالب متكامل لإعلان اجتماعي
...
ينشئ إعلاناً قابلاً لإعادة الاستخدام يمكن تبديل علامته وعنوانه ونظامه البصري ودعوته إلى الإجراء عبر متغيرات بسيطة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="قالب متكامل لإعلان اجتماعي - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: لوحة مقاطع هندسية من أربع خانات
...
تقارن أربعة أجهزة ضمن شبكة دقيقة باستخدام مناظير مفككة ومقاطع شفافة وقياسات وتعليقات هندسية.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="لوحة مقاطع هندسية من أربع خانات - Image 1"></td>
</tr>
</table>

#### التفاصيل

- **المؤلف:** [⁠ luciaAI](https://x.com/luciaverseai)
- **المصدر:** [المصدر](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: قصة مصورة من ثمانية مشاهد عن الصداقة
...
تخطط تسلسلاً عاطفياً بتوجيهات تصوير لطفل صامت يجد الصداقة بعد فقدان دولابه الورقي.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="قصة مصورة من ثمانية مشاهد عن الصداقة - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="قصة مصورة من ثمانية مشاهد عن الصداقة - Image 2"></td>
</tr>
</table>

#### التفاصيل

- **المؤلف:** [H A J R A](https://x.com/codewithhajra)
- **المصدر:** [المصدر](https://x.com/codewithhajra/status/2067971258134745321)
- **تاريخ النشر:** ١٩ يونيو ٢٠٢٦
- **اللغات:** en
...
### No. 7: عملاقة سريالية في البندقية
...
ينشئ بالمنظور القسري صورة سفر مرحة تجلس فيها شخصية عملاقة بين معالم ساحة سان ماركو.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="عملاقة سريالية في البندقية - Image 1"></td>
</tr>
</table>
...
- **المصدر:** [المصدر](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: من صورة مرجعية إلى مجسم مقتنى
...
يحول صورة شخصية إلى مجسم مكتبي واقعي مع شاشة نمذجة وقاعدة شفافة وعلبة مزينة بالرسوم.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="من صورة مرجعية إلى مجسم مقتنى - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="من صورة مرجعية إلى مجسم مقتنى - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="من صورة مرجعية إلى مجسم مقتنى - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="من صورة مرجعية إلى مجسم مقتنى - Image 4"></td>
</tr>
</table>

#### التفاصيل

- **المؤلف:** [Google Gemini](https://x.com/GeminiApp)
- **المصدر:** [المصدر](https://x.com/GeminiApp/status/1962647019090256101)
...
يبني مشهد منتج قابلاً لإعادة الاستخدام بضوء طبيعي ومساحة سلبية مضبوطة وعناصر مساندة اختيارية.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="تصوير تحريري علوي لمنتج - Image 1"></td>
</tr>
</table>

#### التفاصيل

- **المؤلف:** [Mo](https://x.com/Kerroudjm)
- **المصدر:** [المصدر](https://x.com/Kerroudjm/status/1971586126248133068)
- **تاريخ النشر:** ٢٦ سبتمبر ٢٠٢٥
- **اللغات:** en
...
### التحرير الموجّه والتحكم في المدخلات (11)

تعليمات لتعديل صورة موجودة أو ضبط النتيجة باستخدام المناطق والرسومات المرجعية وتعليمات الموضع.

**Community · تعليمات مميزة**

- [من صورة مرجعية إلى مجسم مقتنى](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: ترميم صورة قديمة وتلوينها
...
يصلح الخدوش والتمزقات والبهتان مع الحفاظ على الأشخاص والإضاءة وأجواء الصورة الأصلية.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="ترميم صورة قديمة وتلوينها - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="ترميم صورة قديمة وتلوينها - Image 2"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [WAH](https://x.com/Waheeb33)
- **المصدر:** [المصدر](https://x.com/Waheeb33/status/2052070897813750227)
- **تاريخ النشر:** ٦ مايو ٢٠٢٦
- **اللغات:** en
...
يمزج بورتريهاً جانبياً ومعالم باريس وألوان العلم وحروفاً نافرة في ملصق تذكاري بطابع نحتي.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="ملصق بارز تكريماً لفرنسا - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [Smiling Khan](https://x.com/AIwithkhan)
- **المصدر:** [المصدر](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: بورتريه خيال علمي نيو نوار بمساحة سلبية واسعة
...
يستخدم مرجعاً للوجه لصياغة بورتريه هادئ من زاوية منخفضة تحت سماء غائمة شاسعة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="بورتريه خيال علمي نيو نوار بمساحة سلبية واسعة - Image 1"></td>
</tr>
</table>
...
- **المصدر:** [المصدر](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
يضع الوجه المرجعي في مشهد تحريري بإضاءة طبيعية وملابس تقنية وسيارة دفع رباعي كلاسيكية ضبابية.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="بورتريه خارجي بطابع قوي - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Ahmad Faraz](https://x.com/iamahmedfaraz66)
- **المصدر:** [المصدر](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **تاريخ النشر:** ١٢ يوليو ٢٠٢٦
- **اللغات:** en
...
#### No. 5: سيلفي مرآة بطبقات من الرسوم
...
يضع الشخصية المرجعية في غرفة نوم مضيئة ثم يضيف ملاحظات مكتوبة ورموزاً مرحة وحداً متوهجاً.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="سيلفي مرآة بطبقات من الرسوم - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [Smiling Khan](https://x.com/AIwithkhan)
- **المصدر:** [المصدر](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: جسم يتفكك إلى مكعبات LEGO
...
يجمد جسماً يومياً في منتصف تحوله إلى مكعبات LEGO طافية مع الحفاظ على ألوانه وخاماته.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="جسم يتفكك إلى مكعبات LEGO - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/1969076111628734881)
- **تاريخ النشر:** ١٩ سبتمبر ٢٠٢٥
- **اللغات:** en
...
#### No. 8: حالة جديدة: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="حالة جديدة: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Duet | AI](https://x.com/Sheldon056)
- **المصدر:** [المصدر](https://x.com/Sheldon056/status/2081225700061946007)
...
- **المؤلف:** [Minahil](https://x.com/Minahil42298354)
- **المصدر:** [المصدر](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **المؤلف:** [Minahil](https://x.com/Minahil42298354)
- **المصدر:** [المصدر](https://x.com/Minahil42298354/status/2082038544730612074)
- **تاريخ النشر:** ٢٨ يوليو ٢٠٢٦
- **اللغات:** en
...
- [شعار هندسي سويسري بارز](#prompt-1)
- [ختم شمعي ملمسي للعلامة](#prompt-2)
- [كولاج أزياء لحملة اجتماعية](#prompt-3)
- [قالب متكامل لإعلان اجتماعي](#prompt-4)
- [تصوير تحريري علوي لمنتج](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: حملة تنس للأزياء الراقية

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

يصنع مشهداً رياضياً بسيطاً بمضرب ضخم وأرضية استوديو عاكسة وحروف عملاقة في الخلفية.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="حملة تنس للأزياء الراقية - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [Smiling Khan](https://x.com/AIwithkhan)
- **المصدر:** [المصدر](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: شعار كروم داكن في فراغ أبيض

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

يعرض العلامة بدقة كمعدن مصقول ثقيل مع خدوش دقيقة وتوهج حواف وعمق مجال ضحل وحبيبات فيلم.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="شعار كروم داكن في فراغ أبيض - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: ثلاثية تحريرية فاخرة لكرة السلة
...
مرئيات منظمة يكون فيها ترتيب المعلومات أساسياً، مثل المخططات والرسوم التقنية والتسلسلات والقصص المصورة.

**Community · تعليمات مميزة**

- [لوحة مقاطع هندسية من أربع خانات](#prompt-17)
- [قصة مصورة من ثمانية مشاهد عن الصداقة](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: ديوراما خيال علمي داخل كتاب مفتوح

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

ينظم أربعة موضوعات خيال علمي في صفحة موسوعية 2×2 تجمع ديورامات لعب وتفاصيل أوراق تصميم.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="ديوراما خيال علمي داخل كتاب مفتوح - Image 1"></td>
</tr>
</table>
...
- **المصدر:** [المصدر](https://x.com/Gdgtify/status/2076749503290351717)
- **تاريخ النشر:** ١٣ يوليو ٢٠٢٦
- **اللغات:** en
...
#### No. 15: لوحة دوران لبطل صلب الملامح

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

ورقة شخصية سينمائية موجزة تعرض الشخصية نفسها من الأمام والجانب والخلف.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="لوحة دوران لبطل صلب الملامح - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Gowtham](https://x.com/GowthamCinemas)
- **المصدر:** [المصدر](https://x.com/GowthamCinemas/status/2029505882984501485)
- **تاريخ النشر:** ٥ مارس ٢٠٢٦
- **اللغات:** en
...
#### No. 16: إنفوغرافيك تقني لسفينة سياحية فاخرة

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

يقدم سفينة خيالية عبر مقاطع الطوابق والمواصفات وأبرز المساحات الداخلية ومؤشرات الأداء.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="إنفوغرافيك تقني لسفينة سياحية فاخرة - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [Minahil](https://x.com/Minahil42298354)
- **المصدر:** [المصدر](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: خرائط سفر مصورة بتعليقات ثقافية

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

يبني خرائط دول غنية بمعالم مصغرة وطعام محلي وحياة برية وإحصاءات وتسميات ثنائية اللغة.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="خرائط سفر مصورة بتعليقات ثقافية - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="خرائط سفر مصورة بتعليقات ثقافية - Image 2"></td>
</tr>
</table>
...
- **المؤلف:** [Minahil](https://x.com/Minahil42298354)
- **المصدر:** [المصدر](https://x.com/Minahil42298354/status/2056672835125284972)
- **تاريخ النشر:** ١٩ مايو ٢٠٢٦
- **اللغات:** en
...
#### No. 18: ورقة مواصفات لملابس خارجية تقنية

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

تجمع زوايا القطعة وتفاصيل الخامات والملحقات المعيارية والمواصفات التقنية في لوحة تصميم كاملة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="ورقة مواصفات لملابس خارجية تقنية - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [Minahil](https://x.com/Minahil42298354)
- **المصدر:** [المصدر](https://x.com/Minahil42298354/status/2059570046972670409)
...
#### No. 19: ميكا مستقبلي واقعي

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

وصفة أسلوب قابلة لإعادة الاستخدام تحول الكائنات أو الآلات إلى تصاميم ميكا معدنية وسينمائية وواقعية.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="ميكا مستقبلي واقعي - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [四季橘/Shikikitsu@AIイラストとTRPG(希望)](https://x.com/getkomusen)
- **المصدر:** [المصدر](https://x.com/getkomusen/status/2049059361557746159)
- **تاريخ النشر:** ٢٨ أبريل ٢٠٢٦
- **اللغات:** en
...
#### No. 20: بورتريه غرفة نوم مستقل من تسعينيات القرن الماضي

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

يعيد أجواء صورة عفوية منخفضة الدقة بفلاش مباشر وجدران كولاج وحبيبات فيلم وحنين مستقل.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="بورتريه غرفة نوم مستقل من تسعينيات القرن الماضي - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="بورتريه غرفة نوم مستقل من تسعينيات القرن الماضي - Image 2"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Jahan Zaib](https://x.com/jzaib4269)
- **المصدر:** [المصدر](https://x.com/jzaib4269/status/2068691563522458015)
- **تاريخ النشر:** ٢١ يونيو ٢٠٢٦
- **اللغات:** en
...
#### No. 21: صورة رمزية أحادية بأسلوب Notion
...
ينشئ بورتريهاً متجهياً ذا شخصية بخطوط موحدة واثقة ومساحات سوداء منتقاة بعيداً عن الأيقونات العامة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="صورة رمزية أحادية بأسلوب Notion - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [AmirMušić](https://x.com/AmirMushich)
- **المصدر:** [المصدر](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: بورتريه فسيفسائي هندسي بأسلوب المخططات
...
#### No. 23: بورتريه أزياء أحادي اللون بإضاءة رامبرانت
...
#### No. 24: مشهد أزياء يدمج ثلاثة عشر مرجعا
...
اختبار متعدد المراجع يدمج عارضة وسيارة وملابس وإكسسوارات وحيوانات وأغراضا صغيرة في صورة استوديو متماسكة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="مشهد أزياء يدمج ثلاثة عشر مرجعا - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [@MrDavids1](https://x.com/MrDavids1)
- **المصدر:** [المصدر](https://x.com/MrDavids1/status/1960783672665128970)
- **تاريخ النشر:** ٢٧ أغسطس ٢٠٢٥
- **اللغات:** en
...
#### No. 25: لقطة أحادية قريبة مع تثبيت الهوية
...
#### No. 26: حالة جديدة: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="حالة جديدة: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Muhammad Jamil](https://x.com/JamilAI55)
- **المصدر:** [المصدر](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 28: بورتريه بأسلوب الشارع مع نقاط منقطة

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### الوصف

بورتريه أزياء لـ Nano Banana مستند إلى مصدر موثوق، يحافظ على اتساق بنية الملابس ووضع اليدين وحجم الإكسسوارات وضوء النهار الطبيعي في لقطة كاملة للجسم.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="بورتريه بأسلوب الشارع مع نقاط منقطة - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="بورتريه بأسلوب الشارع مع نقاط منقطة - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="بورتريه بأسلوب الشارع مع نقاط منقطة - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="بورتريه بأسلوب الشارع مع نقاط منقطة - Image 4"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Feyber | AI Creator](https://x.com/woleswoosh)
- **المصدر:** [المصدر](https://x.com/woleswoosh/status/2084247918882791849)
- **تاريخ النشر:** ٣ أغسطس ٢٠٢٦
- **اللغات:** en
...
تعليمات للبيئات والعمارة والمناظر والفن التصوري وبناء العوالم حيث يحمل المكان الفكرة.

**Community · تعليمات مميزة**

- [عملاقة سريالية في البندقية](#prompt-21)
...
يبني منظراً متعدد الطبقات من درب متعرج وزهور برية وشجرة منفردة وحيوانات بعيدة وجبال متوهجة.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="مرج جبلي في الساعة الذهبية - Image 1"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [NUSRAT](https://x.com/nxnusratul)
- **المصدر:** [المصدر](https://x.com/nxnusratul/status/2070499219476230359)
- **تاريخ النشر:** ٢٦ يونيو ٢٠٢٦
- **اللغات:** en
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="حالة جديدة: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="حالة جديدة: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="حالة جديدة: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="حالة جديدة: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [LANDCÄSTER](https://x.com/LANDCASTER_92)
- **المصدر:** [المصدر](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **تاريخ النشر:** ٢٧ يوليو ٢٠٢٦
- **اللغات:** en
...
### الاختبارات المعيارية ومقارنات النماذج (2)

اختبارات مضبوطة لتقييم اتباع التعليمات وسلوك التحرير والاتساق والطباعة والجودة البصرية.
...
يطبق موجز البورتريه نفسه على Gemini 2.5 Flash Image وGemini 3.1 Flash Image لمقارنة النتيجتين.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="مقارنة بورتريه تحريري بين Gemini 2.5 و3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="مقارنة بورتريه تحريري بين Gemini 2.5 و3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="مقارنة بورتريه تحريري بين Gemini 2.5 و3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="مقارنة بورتريه تحريري بين Gemini 2.5 و3.1 - Image 4"></td>
</tr>
</table>

##### التفاصيل

- **المؤلف:** [Nailai7981](https://x.com/VIBEQUIRKLABS)
- **المصدر:** [المصدر](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
- **تاريخ النشر:** ١٦ يونيو ٢٠٢٦
- **اللغات:** en
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="حالة جديدة: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **المؤلف:** [Gadgetify](https://x.com/Gdgtify)
- **المصدر:** [المصدر](https://x.com/Gdgtify/status/2081286397949001917)
- **تاريخ النشر:** ٢٦ يوليو ٢٠٢٦
- **اللغات:** en
...
1. [**إرسال تعليمة جديدة**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
راجع [CONTRIBUTING.md](docs/CONTRIBUTING.md) للاطلاع على الإرشادات التفصيلية.

---

## الترخيص

مرخص بموجب [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
**[تاريخ النجوم](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[عرض المجموعة المنسقة](https://imaginevid.io/ar/nano-banana)** •
...
<sub>تم توليد README هذا تلقائيا. آخر تحديث: 2026-09-16T22:29:10.057Z</sub>
