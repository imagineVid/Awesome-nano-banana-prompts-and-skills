...
> Изучайте рабочие процессы ImagineVid, которые превращают промпт-инжиниринг в визуалы, готовые к продакшену.
# Awesome Nano Banana: промпты и навыки
...
> Подборка промптов Nano Banana, переиспользуемых навыков промптинга и визуальных примеров от ImagineVid

> **Авторство и удаление:** каждый промпт ведёт к публичному источнику и автору. Права остаются у соответствующих владельцев. Для исправления или удаления откройте issue.
...
**[Смотреть коллекцию промптов ImagineVid для Nano Banana](https://imaginevid.io/ru/nano-banana)**

Зачем использовать эту коллекцию?

Действия с продуктом ведут на ImagineVid, а сведения о модели подтверждаются официальной документацией Google.

| Возможность | GitHub README | ImagineVid |
|---------|--------------|---------------------|
| Визуальная структура | Линейный список | Тематические визуальные разделы |
| Поиск | Только Ctrl+F | Структурированные категории |
| Рабочий процесс промпта | - | Переиспользуемые навыки промптов |
| Мобильный просмотр | Базовый | Удобно читать во всех языковых версиях README |
| Категории | - | Просмотр по категориям |


### Просмотр по категориям

- [**Целевое редактирование и контроль входных данных**](#workflow-directed-editing-input-control) - Промпты для изменения исходного изображения и управления результатом через области, эскизы, референсы и указания положения.
- [**Коммерческий дизайн, интерфейсы и плакаты**](#workflow-commercial-design-ui-posters) - Производственные задания для рекламы, продуктовых кампаний, интерфейсов, плакатов, типографики и других дизайн-материалов.
- [**Диаграммы, техническая графика и раскадровки**](#workflow-diagrams-technical-storyboards) - Структурированные изображения, где важен порядок информации: диаграммы, технические чертежи, последовательности и раскадровки.
- [**Персонажи, кино и визуальные стили**](#workflow-characters-cinema-visual-styles) - Промпты для персонажей, портретов, моды, кинокадров и поиска стиля с акцентом на визуальную режиссуру.
- [**Окружение, архитектура и миростроение**](#workflow-environments-architecture-worldbuilding) - Промпты для окружения, архитектуры, пейзажей, концепт-арта и миростроения, где место передаёт идею.
- [**Тесты и сравнения моделей**](#workflow-benchmarks-model-comparisons) - Контролируемые тесты точности инструкций, редактирования, согласованности, типографики и визуального качества.

---

## Содержание

- [Открыть подборку](#открыть-подборку)
- [Что такое Nano Banana?](#что-такое-nano-banana)
...
**Nano Banana** — исходная модель изображений Gemini, официально называемая Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Она принимает текст и изображения, возвращает текст и изображения и оптимизирована для быстрой массовой генерации и диалогового редактирования. В коллекцию входят только подтверждённые промпты с авторством, визуальными доказательствами и контекстом для повторного использования.

- **Нативный мультимодальный ввод** - Объединяйте текстовые инструкции и одно или несколько референсных изображений в одном запросе
- **Генерация и редактирование** - Создавайте изображение, меняйте стиль референса или вносите точечные изменения на естественном языке
- **Низкая задержка** - Модель рассчитана на массовые творческие задачи, где важны скорость и эффективность
- **Диалоговое уточнение** - Меняйте композицию, объект, свет и стиль без полного переписывания задания
- **Профиль исходной модели** - Gemini 2.5 Flash Image создаёт изображения класса 1024 px и добавляет SynthID к результатам
- **Текущее позиционирование** - Google называет её историческим пионером семейства Nano Banana и советует оценивать новые модели семейства для новых проектов

**Источники исследования:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/ru/nano-banana)

### Повторное использование переменных промпта

В некоторых исходных промптах есть переменные в квадратных скобках: `[BRAND]`, `[OBJECT]` или `[NAME]`. Меняйте только значения, сохраняя проверенную визуальную структуру.

**Пример:**
```
Замените `[BRAND]` на свой бренд или `[OBJECT]` на нужный объект, не меняя композицию, свет и материалы.
```

Переменные позволяют повторно использовать промпт с подтверждённым источником без полного переписывания задания.
...
| Всего промптов | **42** |
| Избранное | **9** |
| Обновлено | **воскресенье, 20 сентября 2026 г. в 18:23:02 UTC** |
...
> Отобрано за переиспользуемую структуру, визуальную ясность и творческое разнообразие

<a id="prompt-1"></a>

### No. 1: Швейцарский геометрический логотип с тиснением
...
Превращает знак в центрированный монохромный рельеф с жидким стеклянным кантом и строгими швейцарскими отступами.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Швейцарский геометрический логотип с тиснением - Image 1"></td>
</tr>
</table>

#### Детали

- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/1995542490049290680)
...
### No. 2: Фактурная восковая печать бренда
...
Показывает логотип как глянцевую неровную печать с выпуклым оттиском и мягким предметным светом.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Фактурная восковая печать бренда - Image 1"></td>
</tr>
</table>
...
- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Модный коллаж для кампании в соцсетях
...
Система арт-дирекшена, объединяющая fashion-съёмку, вырезки, типографику и управляемый визуальный хаос.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Модный коллаж для кампании в соцсетях - Image 1"></td>
</tr>
</table>
...
- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Универсальный шаблон рекламы для соцсетей
...
Создаёт повторяемый макет, где бренд, заголовок, визуальная система и призыв меняются компактными переменными.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Универсальный шаблон рекламы для соцсетей - Image 1"></td>
</tr>
</table>
...
- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Четырёхпанельная инженерная доска с разрезами
...
Сравнивает четыре устройства в точной сетке с разнесёнными сборками, прозрачными разрезами, размерами и пояснениями.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Четырёхпанельная инженерная доска с разрезами - Image 1"></td>
</tr>
</table>

#### Детали

- **Автор:** [⁠ luciaAI](https://x.com/luciaverseai)
- **Источник:** [Источник](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Восьмикадровая аниме-раскадровка о дружбе
...
Планирует эмоциональную историю с операторскими указаниями о молчаливом ребёнке, который находит друга после потери бумажной вертушки.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Восьмикадровая аниме-раскадровка о дружбе - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Восьмикадровая аниме-раскадровка о дружбе - Image 2"></td>
</tr>
</table>

#### Детали

- **Автор:** [H A J R A](https://x.com/codewithhajra)
- **Источник:** [Источник](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Сюрреалистическая великанша в Венеции
...
С помощью вынужденной перспективы создаёт игровую фотографию гигантской фигуры среди достопримечательностей площади Сан-Марко.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Сюрреалистическая великанша в Венеции - Image 1"></td>
</tr>
</table>
...
- **Источник:** [Источник](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: Из референсного фото в коллекционную фигурку
...
Превращает фотографию персонажа в реалистичную настольную фигурку с экраном моделирования, прозрачной подставкой и коробкой.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="Из референсного фото в коллекционную фигурку - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="Из референсного фото в коллекционную фигурку - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="Из референсного фото в коллекционную фигурку - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="Из референсного фото в коллекционную фигурку - Image 4"></td>
</tr>
</table>

#### Детали

- **Автор:** [Google Gemini](https://x.com/GeminiApp)
- **Источник:** [Источник](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Редакционная предметная съёмка сверху
...
Создаёт повторяемую сцену с естественным светом, контролируемым свободным пространством и дополнительными предметами.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Редакционная предметная съёмка сверху - Image 1"></td>
</tr>
</table>

#### Детали

- **Автор:** [Mo](https://x.com/Kerroudjm)
- **Источник:** [Источник](https://x.com/Kerroudjm/status/1971586126248133068)
...
> Twitter/X-sourced community prompt cases, сортировка по дате публикации и редакционному порядку.

<a id="workflow-directed-editing-input-control"></a>

### Целевое редактирование и контроль входных данных (11)

Промпты для изменения исходного изображения и управления результатом через области, эскизы, референсы и указания положения.

**Community · Избранные промпты**

- [Из референсного фото в коллекционную фигурку](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Реставрация и колоризация старой фотографии
...
Устраняет царапины, разрывы и выцветание, сохраняя людей, свет и атмосферу исходного снимка.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Реставрация и колоризация старой фотографии - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Реставрация и колоризация старой фотографии - Image 2"></td>
</tr>
</table>

##### Детали

- **Автор:** [WAH](https://x.com/Waheeb33)
- **Источник:** [Источник](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Рельефный плакат-посвящение Франции
...
Соединяет профильный портрет, символы Парижа, цвета флага и тиснёный заголовок в скульптурной композиции.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Рельефный плакат-посвящение Франции - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Smiling Khan](https://x.com/AIwithkhan)
- **Источник:** [Источник](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Неонуарный научно-фантастический портрет с большим негативным пространством
...
Использует референс лица для сдержанного портрета с нижней точки под огромным пасмурным небом.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Неонуарный научно-фантастический портрет с большим негативным пространством - Image 1"></td>
</tr>
</table>
...
- **Источник:** [Источник](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
#### No. 4: Брутальный портрет на открытом воздухе
...
Переносит лицо с референса в естественно освещённую editorial-сцену с технологичной одеждой и размытым винтажным внедорожником.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Брутальный портрет на открытом воздухе - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [Ahmad Faraz](https://x.com/iamahmedfaraz66)
- **Источник:** [Источник](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Опубликовано:** 12 июля 2026 г.
- **Языки:** en
...
#### No. 5: Зеркальное селфи со слоями рисунков
...
Помещает персонажа в светлую спальню и добавляет рукописные заметки, значки и светящийся контур.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Зеркальное селфи со слоями рисунков - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Smiling Khan](https://x.com/AIwithkhan)
- **Источник:** [Источник](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: Объект распадается на детали LEGO
...
Замораживает предмет в момент превращения в парящие детали LEGO, сохраняя исходные цвета и фактуры.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Объект распадается на детали LEGO - Image 1"></td>
</tr>
</table>
...
- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/1969076111628734881)
...
#### No. 7: Вышивка с сохранением структуры референса
...
Преобразуйте загруженную фотографию в фактурную вышивку музейного качества, сохранив композицию, личности, позу и небольшую вставку «до и после».
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Вышивка с сохранением структуры референса - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Smiling Khan](https://x.com/AIwithkhan)
- **Источник:** [Источник](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Новый пример: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Новый пример: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [Duet | AI](https://x.com/Sheldon056)
- **Источник:** [Источник](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Автор:** [Minahil](https://x.com/Minahil42298354)
- **Источник:** [Источник](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Автор:** [Minahil](https://x.com/Minahil42298354)
- **Источник:** [Источник](https://x.com/Minahil42298354/status/2082038544730612074)
- **Опубликовано:** 28 июля 2026 г.
- **Языки:** en
...
- [Швейцарский геометрический логотип с тиснением](#prompt-1)
- [Фактурная восковая печать бренда](#prompt-2)
- [Модный коллаж для кампании в соцсетях](#prompt-3)
- [Универсальный шаблон рекламы для соцсетей](#prompt-4)
- [Редакционная предметная съёмка сверху](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: Теннисная кампания высокой моды

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Создаёт минималистичную спортивную съёмку с огромной ракеткой, отражающим полом и монументальной фоновой надписью.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="Теннисная кампания высокой моды - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Smiling Khan](https://x.com/AIwithkhan)
- **Источник:** [Источник](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Тёмный хромированный логотип в белом пространстве

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Рендерит точный знак как тяжёлый полированный металл с микроцарапинами, свечением кромок, малой глубиной резкости и зерном.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Тёмный хромированный логотип в белом пространстве - Image 1"></td>
</tr>
</table>
...
- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Роскошный баскетбольный редакционный триптих
...
Структурированные изображения, где важен порядок информации: диаграммы, технические чертежи, последовательности и раскадровки.

**Community · Избранные промпты**

- [Четырёхпанельная инженерная доска с разрезами](#prompt-17)
- [Восьмикадровая аниме-раскадровка о дружбе](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Научно-фантастическая диорама в раскрытой книге

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Организует четыре темы в разворот 2×2 с игрушечными диорамами и деталями модельных листов.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Научно-фантастическая диорама в раскрытой книге - Image 1"></td>
</tr>
</table>
...
- **Источник:** [Источник](https://x.com/Gdgtify/status/2076749503290351717)
- **Опубликовано:** 13 июля 2026 г.
- **Языки:** en
...
#### No. 15: Лист разворотов сурового героя

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Компактный кинематографичный лист одного персонажа спереди, сбоку и сзади.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Лист разворотов сурового героя - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [Gowtham](https://x.com/GowthamCinemas)
- **Источник:** [Источник](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Техническая инфографика роскошного круизного лайнера

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Показывает вымышленный лайнер через разрезы палуб, характеристики, интерьеры и приборы производительности.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Техническая инфографика роскошного круизного лайнера - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Minahil](https://x.com/Minahil42298354)
- **Источник:** [Источник](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: Иллюстрированные карты путешествий с культурными пометками

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Создаёт насыщенные карты стран с миниатюрными достопримечательностями, едой, животными, статистикой и двуязычными подписями.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Иллюстрированные карты путешествий с культурными пометками - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Иллюстрированные карты путешествий с культурными пометками - Image 2"></td>
</tr>
</table>
...
- **Автор:** [Minahil](https://x.com/Minahil42298354)
- **Источник:** [Источник](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Технический лист верхней одежды

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Собирает ракурсы изделия, крупные планы материалов, модульные аксессуары и спецификации на одной дизайн-панели.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Технический лист верхней одежды - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Minahil](https://x.com/Minahil42298354)
- **Источник:** [Источник](https://x.com/Minahil42298354/status/2059570046972670409)
...
### Персонажи, кино и визуальные стили (11)

Промпты для персонажей, портретов, моды, кинокадров и поиска стиля с акцентом на визуальную режиссуру.

<a id="prompt-13"></a>

#### No. 19: Фотореалистичный футуристический меха

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Повторяемая стилистическая схема для превращения существ или машин в металлические кинематографичные меха-концепты.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Фотореалистичный футуристический меха - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [四季橘/Shikikitsu@AIイラストとTRPG(希望)](https://x.com/getkomusen)
- **Источник:** [Источник](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: Инди-портрет в спальне 1990-х

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Воссоздаёт случайный lo-fi снимок с прямой вспышкой, стенами-коллажами, плёночным зерном и ностальгией.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Инди-портрет в спальне 1990-х - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Инди-портрет в спальне 1990-х - Image 2"></td>
</tr>
</table>

##### Детали

- **Автор:** [Jahan Zaib](https://x.com/jzaib4269)
- **Источник:** [Источник](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Монохромный аватар в стиле Notion
...
Создаёт выразительный векторный портрет уверенными линиями одной толщины и выборочными чёрными заливками.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Монохромный аватар в стиле Notion - Image 1"></td>
</tr>
</table>
...
- **Автор:** [AmirMušić](https://x.com/AmirMushich)
- **Источник:** [Источник](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Геометрический мозаичный портрет в стиле чертежа

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Соберите современный портрет из сцепленных многоугольных фрагментов, технических построений и смелых модернистских цветовых полей.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Геометрический мозаичный портрет в стиле чертежа - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Геометрический мозаичный портрет в стиле чертежа - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Геометрический мозаичный портрет в стиле чертежа - Image 3"></td>
</tr>
</table>
...
- **Источник:** [Источник](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Монохромный модный портрет в свете Рембрандта
...
#### No. 24: Модная сцена из тринадцати референсов
...
#### No. 25: Ветреный монохромный крупный план с фиксацией личности
...
Краткий референсный портрет с контролем кадра, контраста, взгляда, зерна и волос при сохранении личности.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Ветреный монохромный крупный план с фиксацией личности - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [dreamy digital arts](https://x.com/dreamydigiarts)
- **Источник:** [Источник](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Новый пример: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Новый пример: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [Muhammad Jamil](https://x.com/JamilAI55)
- **Источник:** [Источник](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 28: Уличный портрет в горошек

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Модный портрет для Nano Banana, созданный на основе источника и сохраняющий согласованность формы одежды, положения рук, масштаба аксессуаров и естественного дневного света в полнофигурном кадре.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Уличный портрет в горошек - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Уличный портрет в горошек - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Уличный портрет в горошек - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Уличный портрет в горошек - Image 4"></td>
</tr>
</table>

##### Детали

- **Автор:** [Feyber | AI Creator](https://x.com/woleswoosh)
- **Источник:** [Источник](https://x.com/woleswoosh/status/2084247918882791849)
- **Опубликовано:** 3 августа 2026 г.
- **Языки:** en
...
#### No. 29: Защищённая текстовая зона для читаемого редакционного заголовка

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Документированный рабочий процесс верстки Nano Banana, который защищает место для заголовка, отделяет объект от типографики и сохраняет читаемость каждого слова.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Защищённая текстовая зона для читаемого редакционного заголовка - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [Tim Start](https://x.com/timstartai)
- **Источник:** [Источник](https://x.com/timstartai/status/2084054142671266137)
...
Промпты для окружения, архитектуры, пейзажей, концепт-арта и миростроения, где место передаёт идею.

**Community · Избранные промпты**

- [Сюрреалистическая великанша в Венеции](#prompt-21)

<a id="prompt-20"></a>

#### No. 30: Горный луг в золотой час

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Строит многоплановый пейзаж из извилистой тропы, полевых цветов, одинокого дерева, далёких животных и светящихся гор.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Горный луг в золотой час - Image 1"></td>
</tr>
</table>

##### Детали

- **Автор:** [NUSRAT](https://x.com/nxnusratul)
- **Источник:** [Источник](https://x.com/nxnusratul/status/2070499219476230359)
...
#### No. 31: Новый пример: Battle 🥊 4 Models 1 Models In Image Order
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Новый пример: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Новый пример: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Новый пример: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Новый пример: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>

##### Детали

- **Автор:** [LANDCÄSTER](https://x.com/LANDCASTER_92)
- **Источник:** [Источник](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Опубликовано:** 27 июля 2026 г.
- **Языки:** en
...
### Тесты и сравнения моделей (2)

Контролируемые тесты точности инструкций, редактирования, согласованности, типографики и визуального качества.

<a id="prompt-6"></a>

#### No. 32: Сравнение редакционного портрета Gemini 2.5 и 3.1

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Описание

Применяет один портретный бриф к Gemini 2.5 Flash Image и Gemini 3.1 Flash Image для наглядного сравнения.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Сравнение редакционного портрета Gemini 2.5 и 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Сравнение редакционного портрета Gemini 2.5 и 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Сравнение редакционного портрета Gemini 2.5 и 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Сравнение редакционного портрета Gemini 2.5 и 3.1 - Image 4"></td>
</tr>
</table>

##### Детали

- **Автор:** [Nailai7981](https://x.com/VIBEQUIRKLABS)
- **Источник:** [Источник](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
#### No. 33: Новый пример: 2x2 grid, 16:9, do this for 4 famous days
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Новый пример: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Автор:** [Gadgetify](https://x.com/Gdgtify)
- **Источник:** [Источник](https://x.com/Gdgtify/status/2081286397949001917)
- **Опубликовано:** 26 июля 2026 г.
- **Языки:** en
...
1. [**Отправить новый промпт**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
Подробные правила приведены в [CONTRIBUTING.md](docs/CONTRIBUTING.md).

---

## Лицензия

Материалы распространяются по лицензии [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
...
<details>
<summary>Авторы сообщества (24)</summary>
...
**[История звезд](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[Открыть подборку](https://imaginevid.io/ru/nano-banana)** •
...
<sub>Этот README создан автоматически. Последнее обновление: 2026-09-20T18:23:02.732Z</sub>
