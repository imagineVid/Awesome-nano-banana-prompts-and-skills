...
# Awesome Nano Banana Prompts e Skills
...
As ações do produto apontam para o ImagineVid; as capacidades do modelo baseiam-se na documentação oficial da Google.
...
- [**Edição orientada e controlo de entrada**](#workflow-directed-editing-input-control) - Prompts que alteram uma imagem existente ou controlam o resultado com áreas, esboços, referências e indicações de posição.
- [**Design comercial, UI e cartazes**](#workflow-commercial-design-ui-posters) - Briefings de produção para anúncios, campanhas de produto, interfaces, cartazes, tipografia e outros materiais de design.
- [**Diagramas, arte técnica e storyboards**](#workflow-diagrams-technical-storyboards) - Elementos visuais estruturados em que a ordem da informação importa: diagramas, desenhos técnicos, sequências e storyboards.
- [**Personagens, cinema e estilos visuais**](#workflow-characters-cinema-visual-styles) - Prompts de personagens, retratos, moda, planos cinematográficos e exploração de estilos orientados pela direção visual.
- [**Ambientes, arquitetura e construção de mundos**](#workflow-environments-architecture-worldbuilding) - Prompts de ambientes, arquitetura, paisagens, concept art e construção de mundos em que o lugar transmite a ideia.
- [**Testes e comparações de modelos**](#workflow-benchmarks-model-comparisons) - Testes controlados para avaliar fidelidade ao prompt, edição, consistência, tipografia e qualidade visual.
...
- [O que é Nano Banana?](#o-que-é-nano-banana)
...
- **Fluxo de baixa latência** - Orientado para trabalho criativo em grande volume onde velocidade e eficiência importam
- **Aperfeiçoamento conversacional** - Ajuste composição, sujeito, iluminação ou estilo sem reconstruir todo o briefing
- **Perfil do modelo original** - Gemini 2.5 Flash Image produz resultados na classe de 1024 px e inclui SynthID nas imagens geradas
- **Posicionamento atual** - A Google chama-lhe agora o pioneiro histórico da família Nano Banana e recomenda avaliar modelos mais recentes em novos projetos
...
| Total de prompts | **42** |
| Destaque | **9** |
| Última atualização | **segunda-feira, 14 de setembro de 2026 às 02:25:23 UTC** |
...
Briefings de produção para anúncios, campanhas de produto, interfaces, cartazes, tipografia e outros materiais de design.
...
Constrói uma campanha em três painéis com poses confiantes, piso refletor, cenário carmesim e tipografia motivacional cuidadosamente dirigida.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Tríptico editorial de basquetebol de luxo - Image 1"></td>
</tr>
</table>
...
Elementos visuais estruturados em que a ordem da informação importa: diagramas, desenhos técnicos, sequências e storyboards.
...
### Personagens, cinema e estilos visuais (11)
...
Orienta um retrato introspectivo a preto e branco com luz Rembrandt escultórica, grão controlado e acabamento editorial de luxo.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Retrato de moda monocromático com luz Rembrandt - Image 1"></td>
</tr>
</table>
...
Retrato de referência compacto que controla enquadramento, contraste, olhar, grão e cabelo, preservando a identidade.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Close monocromático com identidade preservada - Image 1"></td>
</tr>
</table>
...
#### No. 27: Retrato editorial neo-japonês em sumi-e

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrição

Um caso baseado em fontes que explora “Retrato editorial neo-japonês em sumi-e”, com instruções reutilizáveis e mídia de resultado verificável.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsBrfWEAAcoeQ.jpg" width="100%" alt="Retrato editorial neo-japonês em sumi-e - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsCfjW8AAjn16.jpg" width="100%" alt="Retrato editorial neo-japonês em sumi-e - Image 2"></td>
</tr>
</table>
...
#### No. 28: Retrato urbano com padrão de bolinhas

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrição

Um retrato de moda do Nano Banana baseado em uma fonte, que mantém coerentes a geometria do vestuário, a posição das mãos, a escala dos acessórios e a luz natural em um enquadramento de corpo inteiro.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Retrato urbano com padrão de bolinhas - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Retrato urbano com padrão de bolinhas - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Retrato urbano com padrão de bolinhas - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Retrato urbano com padrão de bolinhas - Image 4"></td>
</tr>
</table>
...
#### No. 29: Zona de texto protegida para um título editorial desimpedido

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descrição

Um fluxo de composição para Nano Banana baseado numa fonte, que protege o título, separa o sujeito da tipografia e mantém todas as palavras legíveis.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Zona de texto protegida para um título editorial desimpedido - Image 1"></td>
</tr>
</table>
...
#### No. 30: Prado de montanha na hora dourada
...
#### No. 31: Novo caso: Battle 🥊 4 Models 1 Models In Image Order
...
#### No. 32: Comparação de retrato editorial: Gemini 2.5 e 3.1
...
#### No. 33: Novo caso: 2x2 grid, 16:9, do this for 4 famous days
...
<details>
<summary>Autores da comunidade (24)</summary>
...
**[Histórico de stars](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**
...
<sub>README gerado automaticamente. Última atualização: 2026-09-14T02:25:23.808Z</sub>
