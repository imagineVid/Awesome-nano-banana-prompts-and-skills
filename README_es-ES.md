...
# Awesome Nano Banana Prompts y Skills
...
**[Explorar la colección de prompts Nano Banana](https://imaginevid.io/es/nano-banana)**

Por qué usar esta colección

Las acciones del producto llevan a ImagineVid; las capacidades del modelo se apoyan en documentación oficial de Google.
...
- [**Edición dirigida y control de entrada**](#workflow-directed-editing-input-control) - Prompts para modificar una imagen existente o controlar el resultado mediante regiones, bocetos, referencias e indicaciones de posición.
- [**Diseño comercial, UI y carteles**](#workflow-commercial-design-ui-posters) - Briefs de producción para anuncios, campañas de producto, interfaces, carteles, tipografía y otras piezas de diseño.
- [**Diagramas, arte técnico y guiones gráficos**](#workflow-diagrams-technical-storyboards) - Visuales estructurados donde importa el orden de la información: diagramas, planos técnicos, secuencias y guiones gráficos.
- [**Personajes, cine y estilos visuales**](#workflow-characters-cinema-visual-styles) - Prompts de personajes, retrato, moda, fotogramas cinematográficos y exploración de estilos centrados en la dirección visual.
- [**Entornos, arquitectura y creación de mundos**](#workflow-environments-architecture-worldbuilding) - Prompts de entornos, arquitectura, paisajes, arte conceptual y creación de mundos donde el lugar transmite la idea.
- [**Pruebas y comparativas de modelos**](#workflow-benchmarks-model-comparisons) - Pruebas controladas para evaluar el seguimiento del prompt, la edición, la consistencia, la tipografía y la calidad visual.

---

## Índice

- [Ver la colección curada](#ver-la-colección-curada)
- [¿Qué es Nano Banana?](#qué-es-nano-banana)
...
**Nano Banana** es el modelo de imagen Gemini original, identificado oficialmente como Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Admite texto e imágenes como entrada, devuelve texto e imágenes y está optimizado para generación rápida a gran escala y edición conversacional. Esta colección solo acepta casos con autoría, evidencia visual y contexto reutilizable.

- **Entrada multimodal nativa** - Combina instrucciones de texto con una o varias imágenes de referencia en una misma solicitud
- **Generación y edición** - Crea imágenes nuevas, cambia el estilo de una referencia o aplica modificaciones concretas con lenguaje natural
- **Flujo de baja latencia** - Google lo orienta a producción creativa de gran volumen donde importan la velocidad y la eficiencia
- **Refinamiento conversacional** - Ajusta composición, sujeto, iluminación o estilo sin reconstruir todo el encargo
- **Perfil del modelo original** - Gemini 2.5 Flash Image produce resultados de clase 1024 px e incorpora SynthID en las imágenes generadas
- **Posición actual** - Google lo denomina el pionero heredado de la familia Nano Banana y recomienda evaluar modelos más nuevos para producción nueva

**Fuentes de investigación:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/es/nano-banana)

### Reutiliza las variables del prompt

Algunos prompts de origen incluyen variables entre corchetes, como `[BRAND]`, `[OBJECT]` o `[NAME]`. Cambia solo esos valores y conserva la estructura visual ya comprobada.

**Ejemplo:**
```
Sustituye `[BRAND]` por tu marca o `[OBJECT]` por el sujeto deseado; mantén sin cambios la composición, la luz y los materiales.
```

Las variables permiten reutilizar un prompt con fuente verificada sin redactar todo el encargo desde cero.
...
| Prompts totales | **42** |
| Destacado | **9** |
| Última actualización | **miércoles, 23 de septiembre de 2026, 22:33:40 UTC** |
...
### No. 1: Logotipo geométrico suizo en relieve
...
Convierte una marca en un relieve monocromo centrado, con borde de vidrio líquido y un espaciado sobrio de diseño suizo.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Logotipo geométrico suizo en relieve - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/1995542490049290680)
...
### No. 2: Sello de cera de marca con textura
...
Representa el logotipo facilitado como un sello de cera brillante, irregular y en relieve, con luz suave de producto.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Sello de cera de marca con textura - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Collage de moda para una campaña social
...
Un sistema de dirección artística que combina fotografía de moda, recortes, tipografía y desorden visual controlado.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Collage de moda para una campaña social - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Plantilla integrada para anuncios sociales
...
Crea un anuncio reutilizable cuyo nombre, titular, sistema visual y CTA se cambian mediante variables sencillas.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Plantilla integrada para anuncios sociales - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Lámina de ingeniería con cuatro cortes
...
Compara cuatro dispositivos mediante despieces, cortes transparentes, medidas y anotaciones en una cuadrícula precisa.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Lámina de ingeniería con cuatro cortes - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Storyboard de amistad anime en ocho viñetas
...
Diseña una secuencia emotiva, con indicaciones de cámara, sobre un niño silencioso que encuentra amistad tras perder su molinillo.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Storyboard de amistad anime en ocho viñetas - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Storyboard de amistad anime en ocho viñetas - Image 2"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Gigante surrealista en Venecia
...
Crea una fotografía de viaje con perspectiva forzada en la que una figura gigante se sienta entre los monumentos de San Marcos.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Gigante surrealista en Venecia - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: De foto de referencia a figura de colección
...
Convierte una foto de personaje en una figura realista de escritorio con pantalla de modelado, base transparente y caja ilustrada.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="De foto de referencia a figura de colección - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="De foto de referencia a figura de colección - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="De foto de referencia a figura de colección - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="De foto de referencia a figura de colección - Image 4"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Fotografía editorial de producto cenital
...
Crea una escena de producto reutilizable con luz natural, espacio negativo controlado y elementos complementarios opcionales.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Fotografía editorial de producto cenital - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/Kerroudjm/status/1971586126248133068)
...
Prompts para modificar una imagen existente o controlar el resultado mediante regiones, bocetos, referencias e indicaciones de posición.

**Community · Prompts destacados**

- [De foto de referencia a figura de colección](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Restauración y coloreado de una fotografía antigua
...
Repara arañazos, roturas y pérdida de color sin alterar las personas, la luz ni la atmósfera original.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Restauración y coloreado de una fotografía antigua - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Restauración y coloreado de una fotografía antigua - Image 2"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Cartel en relieve como homenaje a Francia
...
Combina un retrato de perfil, monumentos de París, colores nacionales y texto estampado en un cartel escultórico.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Cartel en relieve como homenaje a Francia - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fuente:** [Fuente](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Retrato de ciencia ficción neo-noir con gran espacio negativo
...
Usa una referencia facial para componer un retrato sobrio en contrapicado bajo un cielo nublado dominante.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Retrato de ciencia ficción neo-noir con gran espacio negativo - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
#### No. 4: Retrato de estilo de vida al aire libre
...
Sitúa el rostro de referencia en una escena editorial con luz natural, ropa técnica y un 4x4 clásico desenfocado.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Retrato de estilo de vida al aire libre - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Publicado:** 12 de julio de 2026
- **Idiomas:** en
...
#### No. 5: Selfi ante el espejo con capas de garabatos
...
Coloca al personaje de referencia en un dormitorio luminoso y añade notas, iconos y un contorno brillante sobre la foto.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Selfi ante el espejo con capas de garabatos - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fuente:** [Fuente](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: Objeto que se deshace en ladrillos LEGO
...
Congela un objeto a mitad de su transformación en ladrillos LEGO flotantes, conservando sus colores y texturas.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Objeto que se deshace en ladrillos LEGO - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/1969076111628734881)
...
#### No. 7: Transformación bordada que conserva la referencia
...
Convierte una foto subida en un bordado táctil de calidad museística conservando la composición, las identidades, la pose y una pequeña comparación del antes y el después.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Transformación bordada que conserva la referencia - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fuente:** [Fuente](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Caso nuevo: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Caso nuevo: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Fuente:** [Fuente](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Fuente:** [Fuente](https://x.com/Minahil42298354/status/2082038544730612074)
- **Publicado:** 28 de julio de 2026
- **Idiomas:** en
...
### Diseño comercial, UI y carteles (8)

Briefs de producción para anuncios, campañas de producto, interfaces, carteles, tipografía y otras piezas de diseño.

**Community · Prompts destacados**

- [Logotipo geométrico suizo en relieve](#prompt-1)
- [Sello de cera de marca con textura](#prompt-2)
- [Collage de moda para una campaña social](#prompt-3)
- [Plantilla integrada para anuncios sociales](#prompt-4)
- [Fotografía editorial de producto cenital](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: Campaña de tenis de alta moda

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Crea una editorial deportiva minimalista con raqueta gigante, suelo reflectante y tipografía monumental al fondo.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="Campaña de tenis de alta moda - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fuente:** [Fuente](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Logotipo de cromo oscuro en un vacío blanco

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Representa la marca como metal pulido y pesado, con microarañazos, halo en los bordes, poca profundidad de campo y grano.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Logotipo de cromo oscuro en un vacío blanco - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Tríptico editorial de baloncesto de lujo

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Construye una campaña en tres paneles con poses seguras, parquet reflectante, escenografía carmesí y tipografía motivacional cuidadosamente dirigida.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Tríptico editorial de baloncesto de lujo - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Smiling Khan](https://x.com/AIwithkhan)
- **Fuente:** [Fuente](https://x.com/AIwithkhan/status/2077390591777022413)
...
### Diagramas, arte técnico y guiones gráficos (7)

Visuales estructurados donde importa el orden de la información: diagramas, planos técnicos, secuencias y guiones gráficos.

**Community · Prompts destacados**

- [Lámina de ingeniería con cuatro cortes](#prompt-17)
- [Storyboard de amistad anime en ocho viñetas](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Diorama de ciencia ficción en un libro abierto

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Convierte cuatro temas de ciencia ficción en una doble página 2×2 con dioramas de juguete y fichas de diseño.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Diorama de ciencia ficción en un libro abierto - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/Gdgtify/status/2076749503290351717)
- **Publicado:** 13 de julio de 2026
- **Idiomas:** en
...
#### No. 15: Hoja de vistas de un héroe curtido

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Una ficha cinematográfica compacta que muestra al mismo personaje de frente, de perfil y de espaldas.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Hoja de vistas de un héroe curtido - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Infografía técnica de un crucero de lujo

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Presenta un crucero ficticio mediante cortes de cubierta, especificaciones, interiores destacados e indicadores de rendimiento.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Infografía técnica de un crucero de lujo - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Fuente:** [Fuente](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: Mapas de viaje ilustrados con notas culturales

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Construye mapas nacionales con monumentos en miniatura, gastronomía, fauna, estadísticas y rótulos bilingües.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Mapas de viaje ilustrados con notas culturales - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Mapas de viaje ilustrados con notas culturales - Image 2"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Fuente:** [Fuente](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Ficha técnica de una prenda exterior

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Organiza vistas de la prenda, primeros planos de materiales, accesorios modulares y especificaciones en una lámina de diseño.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Ficha técnica de una prenda exterior - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Minahil](https://x.com/Minahil42298354)
- **Fuente:** [Fuente](https://x.com/Minahil42298354/status/2059570046972670409)
...
Una receta reutilizable para transformar criaturas o máquinas en diseños mecha metálicos, cinematográficos y realistas.
...
- **Fuente:** [Fuente](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: Retrato indie de dormitorio de los años noventa

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Recrea una foto lo-fi espontánea con flash directo, paredes cubiertas de collages, grano y nostalgia indie.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Retrato indie de dormitorio de los años noventa - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Retrato indie de dormitorio de los años noventa - Image 2"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Avatar monocromo al estilo Notion
...
Crea un retrato vectorial con personalidad mediante líneas uniformes seguras y rellenos negros selectivos, sin aspecto de icono genérico.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Avatar monocromo al estilo Notion - Image 1"></td>
</tr>
</table>
...
- **Autor:** [AmirMušić](https://x.com/AmirMushich)
- **Fuente:** [Fuente](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Retrato mosaico con estética de plano técnico

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Construye un retrato contemporáneo con fragmentos poligonales entrelazados, líneas de construcción técnica y campos de color modernistas.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Retrato mosaico con estética de plano técnico - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Retrato mosaico con estética de plano técnico - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Retrato mosaico con estética de plano técnico - Image 3"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Retrato de moda monocromo con luz Rembrandt

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Dirige un retrato introspectivo en blanco y negro con luz Rembrandt escultórica, grano contenido y acabado editorial de lujo.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Retrato de moda monocromo con luz Rembrandt - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Aijaz](https://x.com/iamsofiaijaz)
- **Fuente:** [Fuente](https://x.com/iamsofiaijaz/status/2077233281729536050)
- **Publicado:** 15 de julio de 2026
- **Idiomas:** en
...
#### No. 24: Fusión de trece referencias en una escena de moda
...
Prueba multirreferencia que integra modelo, coche, ropa, accesorios, animales y objetos en una sola fotografía de estudio coherente.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="Fusión de trece referencias en una escena de moda - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/MrDavids1/status/1960783672665128970)
...
#### No. 25: Primer plano monocromo con identidad bloqueada
...
Retrato de referencia conciso que controla encuadre, contraste, mirada, grano y cabello mientras protege la identidad facial.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Primer plano monocromo con identidad bloqueada - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Caso nuevo: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Caso nuevo: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 27: Retrato editorial neo-japonés en sumi-e

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Un caso respaldado por fuentes que explora «Retrato editorial neo-japonés en sumi-e», con instrucciones reutilizables y medios de resultado verificables.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsBrfWEAAcoeQ.jpg" width="100%" alt="Retrato editorial neo-japonés en sumi-e - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsCfjW8AAjn16.jpg" width="100%" alt="Retrato editorial neo-japonés en sumi-e - Image 2"></td>
</tr>
</table>
...
- **Autor:** [zayan](https://x.com/HustleXR)
- **Fuente:** [Fuente](https://x.com/HustleXR/status/2084159526719385833)
...
#### No. 28: Retrato urbano con lunares

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Descripción

Un retrato de moda de Nano Banana basado en una fuente que mantiene coherentes la geometría del vestuario, la posición de las manos, la escala de los accesorios y la luz natural.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Retrato urbano con lunares - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Retrato urbano con lunares - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Retrato urbano con lunares - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Retrato urbano con lunares - Image 4"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/woleswoosh/status/2084247918882791849)
- **Publicado:** 3 de agosto de 2026
- **Idiomas:** en
...
Prompts de entornos, arquitectura, paisajes, arte conceptual y creación de mundos donde el lugar transmite la idea.

**Community · Prompts destacados**

- [Gigante surrealista en Venecia](#prompt-21)
...
Compone un paisaje con sendero sinuoso, flores silvestres, un árbol solitario, fauna lejana y montañas luminosas.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Pradera de montaña en la hora dorada - Image 1"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/nxnusratul/status/2070499219476230359)
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Caso nuevo: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Caso nuevo: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Caso nuevo: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Caso nuevo: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Publicado:** 27 de julio de 2026
- **Idiomas:** en
...
### Pruebas y comparativas de modelos (2)

Pruebas controladas para evaluar el seguimiento del prompt, la edición, la consistencia, la tipografía y la calidad visual.
...
Aplica el mismo encargo de retrato a Gemini 2.5 Flash Image y Gemini 3.1 Flash Image para comparar sus resultados.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Comparativa de retrato editorial: Gemini 2.5 frente a 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Comparativa de retrato editorial: Gemini 2.5 frente a 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Comparativa de retrato editorial: Gemini 2.5 frente a 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Comparativa de retrato editorial: Gemini 2.5 frente a 3.1 - Image 4"></td>
</tr>
</table>
...
- **Fuente:** [Fuente](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Caso nuevo: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Autor:** [Gadgetify](https://x.com/Gdgtify)
- **Fuente:** [Fuente](https://x.com/Gdgtify/status/2081286397949001917)
- **Publicado:** 26 de julio de 2026
- **Idiomas:** en
...
1. [**Enviar nuevo prompt**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
**[Historial de stars](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[Ver la colección curada](https://imaginevid.io/es/nano-banana)** •
...
<sub>Este README se genera automáticamente. Última actualización: 2026-09-23T22:33:40.770Z</sub>
