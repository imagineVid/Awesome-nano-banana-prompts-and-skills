...
> Explorez les workflows ImagineVid pour transformer l’art du prompt en visuels prêts pour la production.
# Awesome Nano Banana Prompts et Skills
...
> Une collection ImagineVid de prompts Nano Banana, de skills réutilisables et d’exemples visuels

> **Attribution et retrait :** chaque prompt renvoie à sa source publique et à son auteur. Les droits restent la propriété de leurs titulaires. Ouvrez une issue pour demander une correction ou un retrait.
...
**[Parcourir la collection de prompts Nano Banana](https://imaginevid.io/fr/nano-banana)**

Pourquoi utiliser cette collection ?

Les actions produit renvoient vers ImagineVid ; les capacités du modèle s’appuient sur la documentation officielle de Google.

| Fonction | GitHub README | Collection ImagineVid |
|---------|--------------|---------------------|
...
| Appareils mobiles | Basique | Lisible dans chaque langue du README |
| Catégories | - | Navigation par catégories |


### Parcourir par catégorie

- [**Édition ciblée et contrôle des entrées**](#workflow-directed-editing-input-control) - Prompts qui modifient une image existante ou pilotent le résultat à l’aide de zones, croquis, références et positions.
- [**Design commercial, UI et affiches**](#workflow-commercial-design-ui-posters) - Briefs de production pour publicités, campagnes produit, interfaces, affiches, typographie et autres supports conçus.
- [**Diagrammes, visuels techniques et storyboards**](#workflow-diagrams-technical-storyboards) - Visuels structurés où l’ordre de l’information compte : diagrammes, dessins techniques, séquences et storyboards.
- [**Personnages, cinéma et styles visuels**](#workflow-characters-cinema-visual-styles) - Prompts de personnages, portraits, mode, plans cinématographiques et recherche de styles guidés par une direction visuelle.
- [**Environnements, architecture et création d’univers**](#workflow-environments-architecture-worldbuilding) - Prompts d’environnements, architecture, paysages, concept art et création d’univers où le lieu porte l’idée.
- [**Évaluations et comparaisons de modèles**](#workflow-benchmarks-model-comparisons) - Tests contrôlés pour évaluer le respect du prompt, l’édition, la cohérence, la typographie et la qualité visuelle.
...
- [Qu’est-ce que Nano Banana ?](#quest-ce-que-nano-banana)
...
**Nano Banana** est le modèle d’image Gemini d’origine, officiellement nommé Gemini 2.5 Flash Image (`gemini-2.5-flash-image`). Il accepte du texte et des images, renvoie du texte et des images, et vise la génération rapide à grande échelle ainsi que la retouche conversationnelle. Cette collection ne retient que des prompts sourcés avec attribution, preuve visuelle et contexte réutilisable.

- **Entrée multimodale native** - Combinez des instructions textuelles avec une ou plusieurs images de référence dans une même requête
- **Génération et retouche** - Créez une image, restylez une référence ou appliquez une modification ciblée en langage naturel
- **Flux à faible latence** - Google le destine aux volumes créatifs élevés où vitesse et efficacité sont prioritaires
- **Affinage conversationnel** - Ajustez composition, sujet, lumière ou style sans reconstruire tout le brief
- **Profil du modèle original** - Gemini 2.5 Flash Image produit des sorties de l’ordre de 1024 px et intègre SynthID aux images générées
- **Positionnement actuel** - Google le présente désormais comme le pionnier historique de la famille Nano Banana et conseille d’évaluer les modèles plus récents pour les nouveaux projets

**Sources de recherche :** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/fr/nano-banana)

### Réutiliser les variables du prompt

Certains prompts sources proposent des variables entre crochets, comme `[BRAND]`, `[OBJECT]` ou `[NAME]`. Ne remplacez que ces valeurs et conservez la structure visuelle éprouvée.

**Exemple :**
```
Remplacez `[BRAND]` par votre marque ou `[OBJECT]` par votre sujet, sans modifier la composition, la lumière ni les matériaux.
```

Les variables rendent un prompt sourcé réutilisable sans réécrire tout le brief à chaque fois.
...
| En vedette | **9** |
| Dernière mise à jour | **vendredi 11 septembre 2026 à 02:05:26 UTC** |
...
### No. 1: Logo géométrique suisse en relief
...
Transforme une marque en relief monochrome centré, bordé d’un effet verre liquide et entouré d’un espace blanc très maîtrisé.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="Logo géométrique suisse en relief - Image 1"></td>
</tr>
</table>
...
**[Utiliser ce prompt · ImagineVid](https://imaginevid.io/fr/nano-banana)**

---

<a id="prompt-2"></a>

### No. 2: Sceau de cire de marque à l’aspect tactile
...
Rend le logo fourni sous forme de sceau brillant, irrégulier et embossé, éclairé comme un produit haut de gamme.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Sceau de cire de marque à l’aspect tactile - Image 1"></td>
</tr>
</table>
...
### No. 3: Collage mode pour campagne sociale
...
Un système de direction artistique mêlant photographie de mode, fragments découpés, typographie et désordre visuel contrôlé.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Collage mode pour campagne sociale - Image 1"></td>
</tr>
</table>
...
### No. 4: Modèle intégré de publicité sociale
...
Crée une publicité réutilisable dont la marque, le titre, le système visuel et l’appel à l’action se remplacent par variables.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Modèle intégré de publicité sociale - Image 1"></td>
</tr>
</table>
...
### No. 5: Planche d’ingénierie en quatre coupes
...
Compare quatre appareils dans une grille précise avec vues éclatées, coupes transparentes, mesures et annotations.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Planche d’ingénierie en quatre coupes - Image 1"></td>
</tr>
</table>
...
### No. 6: Storyboard d’amitié en huit plans d’anime
...
Cadre une histoire émouvante, avec indications de caméra, où un enfant silencieux trouve l’amitié après avoir perdu son moulinet.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Storyboard d’amitié en huit plans d’anime - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Storyboard d’amitié en huit plans d’anime - Image 2"></td>
</tr>
</table>
...
### No. 7: Géante surréaliste à Venise
...
Met en scène, par perspective forcée, une photographie de voyage ludique entre les monuments de la place Saint-Marc.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Géante surréaliste à Venise - Image 1"></td>
</tr>
</table>
...
### No. 8: D’une photo de référence à une figurine de collection
...
Transforme une photo de personnage en figurine réaliste de bureau avec écran de modélisation, socle transparent et boîte illustrée.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="D’une photo de référence à une figurine de collection - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="D’une photo de référence à une figurine de collection - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="D’une photo de référence à une figurine de collection - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="D’une photo de référence à une figurine de collection - Image 4"></td>
</tr>
</table>
...
### No. 9: Photographie éditoriale de produit en plongée verticale
...
Crée une scène réutilisable avec lumière naturelle, espace négatif maîtrisé et éléments d’accompagnement facultatifs.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Photographie éditoriale de produit en plongée verticale - Image 1"></td>
</tr>
</table>
...
Prompts qui modifient une image existante ou pilotent le résultat à l’aide de zones, croquis, références et positions.

**Community · Prompts en vedette**

- [D’une photo de référence à une figurine de collection](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Restaurer et coloriser une photographie ancienne
...
Répare rayures, déchirures et décoloration tout en préservant les personnes, la lumière et l’atmosphère de l’original.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Restaurer et coloriser une photographie ancienne - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Restaurer et coloriser une photographie ancienne - Image 2"></td>
</tr>
</table>
...
#### No. 2: Affiche en relief en hommage à la France
...
Associe portrait de profil, monuments parisiens, couleurs nationales et titre embossé dans une composition sculpturale.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Affiche en relief en hommage à la France - Image 1"></td>
</tr>
</table>
...
#### No. 3: Portrait de science-fiction néo-noir en espace négatif
...
Utilise un visage de référence pour mettre en scène un portrait sobre en contre-plongée sous un vaste ciel couvert.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Portrait de science-fiction néo-noir en espace négatif - Image 1"></td>
</tr>
</table>
...
#### No. 4: Portrait outdoor au style robuste
...
Place le visage de référence dans une scène éditoriale en lumière naturelle, avec vêtements techniques et 4×4 ancien flouté.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Portrait outdoor au style robuste - Image 1"></td>
</tr>
</table>
...
#### No. 5: Selfie miroir couvert de gribouillis
...
Place le personnage de référence dans une chambre lumineuse puis ajoute notes manuscrites, icônes et contour lumineux.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Selfie miroir couvert de gribouillis - Image 1"></td>
</tr>
</table>
...
#### No. 6: Objet se désagrégeant en briques LEGO
...
Fige un objet au milieu de sa transformation en briques LEGO flottantes tout en conservant ses couleurs et ses textures.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="Objet se désagrégeant en briques LEGO - Image 1"></td>
</tr>
</table>
...
#### No. 7: Transformation brodée fidèle à l’image de référence
...
Transformez une photo importée en broderie tactile de qualité muséale tout en conservant la composition, les identités, la pose et une petite vignette avant-après.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Transformation brodée fidèle à l’image de référence - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Smiling Khan](https://x.com/AIwithkhan)
- **Source:** [Source](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Nouveau cas : This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Nouveau cas : This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
- **Source:** [Source](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Source:** [Source](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Auteur:** [Minahil](https://x.com/Minahil42298354)
- **Source:** [Source](https://x.com/Minahil42298354/status/2082038544730612074)
- **Publié:** 28 juillet 2026
- **Langues:** en
...
### Design commercial, UI et affiches (8)

Briefs de production pour publicités, campagnes produit, interfaces, affiches, typographie et autres supports conçus.

**Community · Prompts en vedette**

- [Logo géométrique suisse en relief](#prompt-1)
- [Sceau de cire de marque à l’aspect tactile](#prompt-2)
- [Collage mode pour campagne sociale](#prompt-3)
- [Modèle intégré de publicité sociale](#prompt-4)
- [Photographie éditoriale de produit en plongée verticale](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: Campagne tennis haute couture

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Compose un éditorial sportif minimaliste avec raquette géante, sol réfléchissant et typographie monumentale en arrière-plan.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="Campagne tennis haute couture - Image 1"></td>
</tr>
</table>
...
#### No. 12: Logo en chrome sombre dans un vide blanc

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Rend la marque comme un métal poli et lourd, avec micro-rayures, halo de bord, faible profondeur de champ et grain argentique.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Logo en chrome sombre dans un vide blanc - Image 1"></td>
</tr>
</table>
...
#### No. 13: Triptyque éditorial de basket haut de gamme

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Compose une campagne en trois panneaux avec poses assurées, parquet réfléchissant, décor cramoisi et typographie motivante précisément dirigée.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Triptyque éditorial de basket haut de gamme - Image 1"></td>
</tr>
</table>
...
Visuels structurés où l’ordre de l’information compte : diagrammes, dessins techniques, séquences et storyboards.

**Community · Prompts en vedette**

- [Planche d’ingénierie en quatre coupes](#prompt-17)
- [Storyboard d’amitié en huit plans d’anime](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Diorama de science-fiction dans un livre ouvert

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Organise quatre sujets de science-fiction en double page 2×2, entre dioramas miniatures et planches de conception.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Diorama de science-fiction dans un livre ouvert - Image 1"></td>
</tr>
</table>
...
#### No. 15: Planche de rotation d’un héros endurci

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Une fiche de personnage cinématographique montrant la même silhouette de face, de profil et de dos.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Planche de rotation d’un héros endurci - Image 1"></td>
</tr>
</table>
...
#### No. 16: Infographie technique d’un paquebot de luxe

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Présente un navire fictif par des coupes de ponts, données techniques, espaces intérieurs et jauges de performance.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Infographie technique d’un paquebot de luxe - Image 1"></td>
</tr>
</table>
...
#### No. 17: Cartes de voyage illustrées et annotées

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Construit des cartes nationales riches en monuments miniatures, gastronomie, faune, statistiques et légendes bilingues.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Cartes de voyage illustrées et annotées - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Cartes de voyage illustrées et annotées - Image 2"></td>
</tr>
</table>
...
#### No. 18: Fiche technique de vêtement d’extérieur

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Réunit vues du vêtement, gros plans matière, accessoires modulaires et caractéristiques sur une planche complète.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Fiche technique de vêtement d’extérieur - Image 1"></td>
</tr>
</table>
...
### Personnages, cinéma et styles visuels (11)

Prompts de personnages, portraits, mode, plans cinématographiques et recherche de styles guidés par une direction visuelle.

<a id="prompt-13"></a>

#### No. 19: Mecha futuriste photoréaliste

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Une recette de style réutilisable pour transformer créatures ou machines en mechas métalliques, cinématographiques et réalistes.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Mecha futuriste photoréaliste - Image 1"></td>
</tr>
</table>
...
#### No. 20: Portrait indie dans une chambre des années 1990

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Recrée une photo lo-fi spontanée avec flash direct, murs couverts de collages, grain argentique et nostalgie indépendante.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="Portrait indie dans une chambre des années 1990 - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="Portrait indie dans une chambre des années 1990 - Image 2"></td>
</tr>
</table>
...
#### No. 21: Avatar monochrome dans le style Notion
...
Crée un portrait vectoriel expressif avec lignes monolignes assurées et aplats noirs sélectifs, loin des icônes génériques.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Avatar monochrome dans le style Notion - Image 1"></td>
</tr>
</table>
...
#### No. 22: Portrait mosaïque aux accents de plan technique

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Composez un portrait contemporain à partir de fragments polygonaux imbriqués, de lignes de construction techniques et d’aplats modernistes audacieux.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Portrait mosaïque aux accents de plan technique - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Portrait mosaïque aux accents de plan technique - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Portrait mosaïque aux accents de plan technique - Image 3"></td>
</tr>
</table>
...
- **Source:** [Source](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Portrait de mode monochrome éclairé à la Rembrandt

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Dirige un portrait noir et blanc introspectif avec lumière Rembrandt sculpturale, grain maîtrisé et finition éditoriale luxueuse.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Portrait de mode monochrome éclairé à la Rembrandt - Image 1"></td>
</tr>
</table>
...
#### No. 24: Scène de mode fusionnant treize références
...
Test multiréférence réunissant mannequin, voiture, vêtements, accessoires, animaux et petits objets dans une photo de studio cohérente.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="Scène de mode fusionnant treize références - Image 1"></td>
</tr>
</table>
...
- **Source:** [Source](https://x.com/MrDavids1/status/1960783672665128970)
- **Publié:** 27 août 2025
- **Langues:** en
...
#### No. 25: Gros plan monochrome avec identité verrouillée
...
Portrait de référence concis qui contrôle cadrage, contraste, regard, grain et cheveux tout en protégeant l’identité.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Gros plan monochrome avec identité verrouillée - Image 1"></td>
</tr>
</table>
...
#### No. 26: Nouveau cas : □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Nouveau cas : □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
- **Source:** [Source](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 27: Portrait éditorial néo-japonais en sumi-e

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Un cas documenté par une source autour de « Portrait éditorial néo-japonais en sumi-e », avec des instructions réutilisables et un résultat vérifiable.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsBrfWEAAcoeQ.jpg" width="100%" alt="Portrait éditorial néo-japonais en sumi-e - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOxsCfjW8AAjn16.jpg" width="100%" alt="Portrait éditorial néo-japonais en sumi-e - Image 2"></td>
</tr>
</table>
...
#### No. 28: Portrait streetwear à pois

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Un portrait de mode Nano Banana documenté par une source, qui maintient la géométrie des vêtements, la position des mains, l’échelle des accessoires et la lumière naturelle.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Portrait streetwear à pois - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Portrait streetwear à pois - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Portrait streetwear à pois - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Portrait streetwear à pois - Image 4"></td>
</tr>
</table>
...
- **Source:** [Source](https://x.com/woleswoosh/status/2084247918882791849)
- **Publié:** 3 août 2026
- **Langues:** en
...
#### No. 29: Zone de texte protégée pour un titre éditorial parfaitement lisible

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Un workflow de mise en page Nano Banana documenté par une source, qui protège le titre, éloigne le sujet de la typographie et garde chaque mot lisible.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Zone de texte protégée pour un titre éditorial parfaitement lisible - Image 1"></td>
</tr>
</table>
...
### Environnements, architecture et création d’univers (3)

Prompts d’environnements, architecture, paysages, concept art et création d’univers où le lieu porte l’idée.

**Community · Prompts en vedette**

- [Géante surréaliste à Venise](#prompt-21)

<a id="prompt-20"></a>

#### No. 30: Prairie de montagne à l’heure dorée

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Structure un paysage avec sentier sinueux, fleurs sauvages, arbre solitaire, animaux lointains et chaîne montagneuse lumineuse.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Prairie de montagne à l’heure dorée - Image 1"></td>
</tr>
</table>
...
#### No. 31: Nouveau cas : Battle 🥊 4 Models 1 Models In Image Order
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Nouveau cas : Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Nouveau cas : Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Nouveau cas : Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Nouveau cas : Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
- **Source:** [Source](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Publié:** 27 juillet 2026
- **Langues:** en
...
### Évaluations et comparaisons de modèles (2)

Tests contrôlés pour évaluer le respect du prompt, l’édition, la cohérence, la typographie et la qualité visuelle.

<a id="prompt-6"></a>

#### No. 32: Comparatif de portrait éditorial Gemini 2.5 contre 3.1

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Description

Soumet le même brief de portrait à Gemini 2.5 Flash Image et Gemini 3.1 Flash Image pour comparer leur rendu.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Comparatif de portrait éditorial Gemini 2.5 contre 3.1 - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Comparatif de portrait éditorial Gemini 2.5 contre 3.1 - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Comparatif de portrait éditorial Gemini 2.5 contre 3.1 - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Comparatif de portrait éditorial Gemini 2.5 contre 3.1 - Image 4"></td>
</tr>
</table>
...
#### No. 33: Nouveau cas : 2x2 grid, 16:9, do this for 4 famous days
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Nouveau cas : 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Auteur:** [Gadgetify](https://x.com/Gdgtify)
- **Source:** [Source](https://x.com/Gdgtify/status/2081286397949001917)
- **Publié:** 26 juillet 2026
- **Langues:** en
...
1. [**Soumettre un nouveau prompt**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
...
<details>
<summary>Auteurs de la communauté (24)</summary>
...
**[Historique des stars](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**

---

<div align="center">

**[Voir la collection](https://imaginevid.io/fr/nano-banana)** •
...
<sub>Ce README est généré automatiquement. Dernière mise à jour : 2026-09-11T02:05:26.638Z</sub>
