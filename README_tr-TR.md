...
# Awesome Nano Banana Promptları ve Becerileri
...
> ImagineVid tarafından seçilmiş Nano Banana promptları, yeniden kullanılabilir prompt becerileri ve görsel örnekler

> **Atıf ve kaldırma:** Her prompt, herkese açık kaynağına ve üreticisine bağlanır. Haklar ilgili sahiplerinde kalır. Düzeltme veya kaldırma talebi için issue açın.
...
**[Seçilmiş koleksiyonu görüntüle](https://imaginevid.io/tr/nano-banana)**

Bu koleksiyon neden kullanılır?

Ürün işlemleri ImagineVid'e, model yetenekleri ise resmi Google belgelerine bağlanır.

| Özellik | GitHub README | ImagineVid |
|---------|--------------|---------------------|
| Görsel düzen | Kaynak odaklı sıralı başvuru | Kategori bazlı görsel keşif |
| Ara | Depo içinde arama | Yapılandırılmış editoryal gezinme |
| Prompt iş akışı | - | Değişkenli yeniden kullanılabilir promptlar |
| Mobil | Yerel Markdown | Her dil sürümünde okunabilir |
| Kategoriler | - | Kategoriye göre gez |


### Kategoriye göre gez

- [**Yönlendirilmiş düzenleme ve girdi kontrolü**](#workflow-directed-editing-input-control) - Mevcut bir görseli değiştiren veya bölgeler, eskizler, referanslar ve konum talimatlarıyla sonucu yöneten promptlar.
- [**Ticari tasarım, arayüz ve posterler**](#workflow-commercial-design-ui-posters) - Reklamlar, ürün kampanyaları, arayüzler, posterler, tipografi ve diğer tasarım çıktıları için üretim briefleri.
- [**Diyagramlar, teknik görseller ve storyboardlar**](#workflow-diagrams-technical-storyboards) - Bilgi sırasının önemli olduğu diyagramlar, teknik çizimler, çok kareli diziler ve storyboardlar.
- [**Karakterler, sinema ve görsel stiller**](#workflow-characters-cinema-visual-styles) - Görsel yönetim ve görüntü diline odaklanan karakter, portre, moda, sinema karesi ve stil keşfi promptları.
- [**Ortamlar, mimari ve dünya inşası**](#workflow-environments-architecture-worldbuilding) - Mekânın fikri taşıdığı çevre, mimari, manzara, konsept sanat ve dünya kurma promptları.
- [**Karşılaştırmalar ve model kıyaslamaları**](#workflow-benchmarks-model-comparisons) - Prompt takibi, düzenleme davranışı, tutarlılık, tipografi ve görsel kaliteyi ölçen kontrollü testler.

---

## İçindekiler

- [Seçilmiş koleksiyonu görüntüle](#seçilmiş-koleksiyonu-görüntüle)
- [Nano Banana nedir?](#nano-banana-nedir)
...
- [Nasıl katkı verilir](#nasıl-katkı-verilir)
- [Lisans](#lisans)
...
**Nano Banana**, resmi adı Gemini 2.5 Flash Image (`gemini-2.5-flash-image`) olan ilk Gemini görüntü modelidir. Metin ve görüntü girdilerini işler, metin ve görüntü çıktısı verir; hızlı, yüksek hacimli üretim ve konuşmalı düzenleme için optimize edilmiştir. Bu koleksiyon yalnızca kaynak, üretici atfı, görsel kanıt ve yeniden kullanım bağlamı bulunan istemleri kabul eder.

- **Yerel çok modlu giriş** - Metin talimatlarını bir veya daha fazla referans görselle aynı istekte birleştirin
- **Üretim ve düzenleme** - Yeni görüntü üretin, referansı yeniden biçimlendirin veya doğal dille hedefli değişiklik uygulayın
- **Düşük gecikmeli iş akışı** - Hız ve verimliliğin önemli olduğu yüksek hacimli yaratıcı işler için konumlandırılmıştır
- **Konuşmalı iyileştirme** - Özeti baştan kurmadan kompozisyonu, özneyi, ışığı ve stili ayarlayın
- **İlk model profili** - Gemini 2.5 Flash Image 1024 px sınıfında çıktı üretir ve oluşturulan görüntülere SynthID ekler
- **Güncel konum** - Google modeli Nano Banana ailesinin öncüsü olarak tanımlar ve yeni üretimler için daha yeni aile modellerinin değerlendirilmesini önerir

**Araştırma kaynakları:** [Gemini image generation guide](https://ai.google.dev/gemini-api/docs/image-generation) · [Gemini 2.5 Flash Image model page](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-image) · [Nano Banana on ImagineVid](https://imaginevid.io/tr/nano-banana)

### Prompt değişkenlerini yeniden kullanın

Bazı kaynak promptlarda `[BRAND]`, `[OBJECT]` veya `[NAME]` gibi köşeli parantezli değişkenler bulunur. Yalnızca bu değerleri değiştirin ve denenmiş görsel yapıyı koruyun.

**Örnek:**
```
`[BRAND]` alanını markanızla veya `[OBJECT]` alanını hedef nesneyle değiştirin; kompozisyon, ışık ve malzeme talimatlarını koruyun.
```

Değişkenler, kaynaklı bir promptu tüm briefi baştan yazmadan güvenilir biçimde yeniden kullanmayı sağlar.
...
| Toplam prompt | **42** |
| Öne çıkan | **9** |
| Son güncelleme | **17 Ağustos 2026 Pazartesi 12:23:11 UTC** |
...
> Yeniden kullanım, görsel açıklık ve yaratıcı çeşitlilik için seçildi

<a id="prompt-1"></a>

### No. 1: İsviçre geometrisinde kabartma logo
...
Markayı sıvı cam kenarlı, ölçülü boşluk kullanan ve ortalanmış tek renkli bir kabartmaya dönüştürür.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G7GW1EjWgAAgtWV.jpg" width="100%" alt="İsviçre geometrisinde kabartma logo - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/1995542490049290680)
...
Verilen logoyu kabartmalı iz, doğal biçim bozukluğu ve yumuşak ürün ışığı taşıyan parlak bir mum mührü olarak işler.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G70LO0WXQAIlvMY.jpg" width="100%" alt="Dokulu marka mum mührü - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [AmirMušić](https://x.com/AmirMushich)
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/1998766162033713370)
...
### No. 3: Sosyal kampanya için moda kolajı
...
Moda fotoğrafı, kesilmiş parçalar, tipografi ve denetimli görsel karmaşayı birleştiren sanat yönetimi sistemi.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HAupnj7XgAIL_ja.jpg" width="100%" alt="Sosyal kampanya için moda kolajı - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [AmirMušić](https://x.com/AmirMushich)
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/2020895358126002197)
...
### No. 4: Bütünleşik sosyal reklam şablonu
...
Marka, başlık, görsel sistem ve eylem çağrısı kısa değişkenlerle değiştirilebilen yeniden kullanılabilir bir reklam oluşturur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HB7r12tWMAA1nTv.jpg" width="100%" alt="Bütünleşik sosyal reklam şablonu - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [AmirMušić](https://x.com/AmirMushich)
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/2026316195977146728)
...
### No. 5: Dört panelli mühendislik kesit panosu
...
Dört tüketici cihazını patlatılmış görünüm, saydam kesit, ölçü ve mühendislik notlarıyla karşılaştırır.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HKEHL3YbsAAFhpN.jpg" width="100%" alt="Dört panelli mühendislik kesit panosu - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/luciaverseai/status/2062938095109255382)
...
### No. 6: Sekiz karelik anime dostluk storyboardu
...
Kâğıt fırıldağını kaybeden sessiz bir çocuğun dostluk bulmasını çekim yönleriyle duygusal bir sekansa dönüştürür.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLLo2ekWEAASktJ.jpg" width="100%" alt="Sekiz karelik anime dostluk storyboardu - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/amplify_video_thumb/2067971201561989120/img/HGb-fSrVr8UrbrJi.jpg" width="100%" alt="Sekiz karelik anime dostluk storyboardu - Image 2"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/codewithhajra/status/2067971258134745321)
...
### No. 7: Venedik'te gerçeküstü dev figür
...
Zorlanmış perspektifle dev bir figürü San Marco Meydanı'nın simgeleri arasında oturtan eğlenceli bir gezi fotoğrafı üretir.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMD5qkpXIAAEnOO.jpg" width="100%" alt="Venedik'te gerçeküstü dev figür - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/AIwithkhan/status/2071930341552701579)
...
### No. 8: Referans fotoğraftan koleksiyon figürüne
...
Karakter fotoğrafını modelleme ekranı, şeffaf taban ve resimli kutuyla gerçekçi bir masaüstü figürüne dönüştürür.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4V72WwAA7PRR.jpg" width="100%" alt="Referans fotoğraftan koleksiyon figürüne - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4d2ka0AAtnQV.jpg" width="100%" alt="Referans fotoğraftan koleksiyon figürüne - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4h2qXUAA3FA5.jpg" width="100%" alt="Referans fotoğraftan koleksiyon figürüne - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/Gzy4oMyWwAAmyWW.jpg" width="100%" alt="Referans fotoğraftan koleksiyon figürüne - Image 4"></td>
</tr>
</table>

#### Detaylar

- **Yazar:** [Google Gemini](https://x.com/GeminiApp)
- **Kaynak:** [Kaynak](https://x.com/GeminiApp/status/1962647019090256101)
...
### No. 9: Üstten editoryal ürün fotoğrafı
...
Doğal güneş, denetimli boşluk ve isteğe bağlı yardımcı ögelerle yeniden kullanılabilir bir üstten ürün sahnesi kurar.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1x51QZWEAAvZ9-.jpg" width="100%" alt="Üstten editoryal ürün fotoğrafı - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/Kerroudjm/status/1971586126248133068)
- **Yayınlandı:** 26 Eylül 2025
- **Diller:** en
...
> Twitter/X-sourced community prompt cases, yayın tarihi ve editoryal önceliğe göre sıralı.

<a id="workflow-directed-editing-input-control"></a>

### Yönlendirilmiş düzenleme ve girdi kontrolü (11)

Mevcut bir görseli değiştiren veya bölgeler, eskizler, referanslar ve konum talimatlarıyla sonucu yöneten promptlar.

**Community · Öne çıkan promptlar**

- [Referans fotoğraftan koleksiyon figürüne](#prompt-23)

<a id="prompt-5"></a>

#### No. 1: Eski fotoğrafı onarma ve renklendirme
...
Kaynak fotoğraftaki kişileri, ışığı ve atmosferi koruyarak çizikleri, yırtıkları ve solmayı giderir.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfykbAAAqqzm.jpg" width="100%" alt="Eski fotoğrafı onarma ve renklendirme - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HHpJfyMaUAEx6ei.jpg" width="100%" alt="Eski fotoğrafı onarma ve renklendirme - Image 2"></td>
</tr>
</table>

##### Detaylar

- **Yazar:** [WAH](https://x.com/Waheeb33)
- **Kaynak:** [Kaynak](https://x.com/Waheeb33/status/2052070897813750227)
...
#### No. 2: Fransa'ya saygı kabartma afişi
...
Profil portresi, Paris simgeleri, bayrak renkleri ve kabartma yazıyı heykelsi bir anma afişinde birleştirir.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM842XhbgAAIfMr.jpg" width="100%" alt="Fransa'ya saygı kabartma afişi - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Smiling Khan](https://x.com/AIwithkhan)
- **Kaynak:** [Kaynak](https://x.com/AIwithkhan/status/2075940468970721456)
...
#### No. 3: Geniş negatif alanlı neo-noir bilim kurgu portresi
...
Yüz referansını, geniş kapalı gökyüzü altında ölçülü bir alçak açı portresine dönüştürür.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNCG4yGbgAA4Txd.jpg" width="100%" alt="Geniş negatif alanlı neo-noir bilim kurgu portresi - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/iamsofiaijaz/status/2076307753258410285)
...
#### No. 4: Sert görünümlü açık hava yaşam portresi
...
Referans yüzü doğal ışıklı bir editoryal sahneye yerleştirir; teknik kıyafet ve flu klasik arazi aracı ekler.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNChcwZacAAmyXi.jpg" width="100%" alt="Sert görünümlü açık hava yaşam portresi - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/iamahmedfaraz66/status/2076336951184249038)
- **Yayınlandı:** 12 Temmuz 2026
- **Diller:** en
...
#### No. 5: Karalama katmanlı ayna selfiesi
...
Referans karakteri aydınlık bir yatak odasına yerleştirir; el yazısı notlar, simgeler ve ışıklı dış çizgi ekler.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMeKH7ibMAAmCHU.jpg" width="100%" alt="Karalama katmanlı ayna selfiesi - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Smiling Khan](https://x.com/AIwithkhan)
- **Kaynak:** [Kaynak](https://x.com/AIwithkhan/status/2073778025649541492)
...
#### No. 6: LEGO parçalarına dağılan nesne
...
Gündelik bir nesneyi, özgün renk ve dokularını koruyarak havada süzülen LEGO parçalarına dönüşürken dondurur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G1OQSQTW0AcNWdd.jpg" width="100%" alt="LEGO parçalarına dağılan nesne - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [AmirMušić](https://x.com/AmirMushich)
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/1969076111628734881)
- **Yayınlandı:** 19 Eylül 2025
- **Diller:** en
...
#### No. 7: Referansı koruyan nakış dokusu dönüşümü
...
Yüklenen fotoğrafı; kompozisyonu, kimlikleri, pozu ve küçük bir önce-sonra görselini koruyarak dokunsal, müze kalitesinde bir nakış eserine dönüştürün.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNMA5IJa8AAokAk.jpg" width="100%" alt="Referansı koruyan nakış dokusu dönüşümü - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Smiling Khan](https://x.com/AIwithkhan)
- **Kaynak:** [Kaynak](https://x.com/AIwithkhan/status/2077004845312331809)
...
#### No. 8: Yeni örnek: This image Upload Your Image into a 64K DSLR
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOH_vMobUAAAZf1.jpg" width="100%" alt="Yeni örnek: This image Upload Your Image into a 64K DSLR - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/Sheldon056/status/2081225700061946007)
...
- **Kaynak:** [Kaynak](https://x.com/Minahil42298354/status/2082052148540375267)
...
- **Yazar:** [Minahil](https://x.com/Minahil42298354)
- **Kaynak:** [Kaynak](https://x.com/Minahil42298354/status/2082038544730612074)
- **Yayınlandı:** 28 Temmuz 2026
- **Diller:** en
...
### Ticari tasarım, arayüz ve posterler (8)

Reklamlar, ürün kampanyaları, arayüzler, posterler, tipografi ve diğer tasarım çıktıları için üretim briefleri.

**Community · Öne çıkan promptlar**

- [İsviçre geometrisinde kabartma logo](#prompt-1)
- [Dokulu marka mum mührü](#prompt-2)
- [Sosyal kampanya için moda kolajı](#prompt-3)
- [Bütünleşik sosyal reklam şablonu](#prompt-4)
- [Üstten editoryal ürün fotoğrafı](#prompt-25)

<a id="prompt-10"></a>

#### No. 11: Yüksek moda tenis kampanyası

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Dev raket, yansıtıcı stüdyo zemini ve büyük arka plan yazısıyla yalın bir spor editoryali oluşturur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNG5K0gaEAAPTuo.jpg" width="100%" alt="Yüksek moda tenis kampanyası - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Smiling Khan](https://x.com/AIwithkhan)
- **Kaynak:** [Kaynak](https://x.com/AIwithkhan/status/2076644507245048242)
...
#### No. 12: Beyaz boşlukta koyu krom logo

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Kesin marka biçimini mikro çizikler, kenar parlaması, sığ alan derinliği ve grenle ağır cilalı metal olarak işler.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G8OagDzXAAEjhzO.jpg" width="100%" alt="Beyaz boşlukta koyu krom logo - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [AmirMušić](https://x.com/AmirMushich)
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/2000614012422136108)
...
#### No. 13: Lüks basketbol editoryal üçlemesi

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Kendinden emin sporcu pozları, yansıtıcı parke, koyu kırmızı sahne ve özenle yönlendirilmiş motivasyon tipografisiyle üç panelli bir kampanya oluşturun.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNRfurkakAAdwMv.jpg" width="100%" alt="Lüks basketbol editoryal üçlemesi - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Smiling Khan](https://x.com/AIwithkhan)
- **Kaynak:** [Kaynak](https://x.com/AIwithkhan/status/2077390591777022413)
...
Bilgi sırasının önemli olduğu diyagramlar, teknik çizimler, çok kareli diziler ve storyboardlar.

**Community · Öne çıkan promptlar**

- [Dört panelli mühendislik kesit panosu](#prompt-17)
- [Sekiz karelik anime dostluk storyboardu](#prompt-18)

<a id="prompt-11"></a>

#### No. 14: Açık kitapta bilim kurgu hikâye dioraması

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Dört bilim kurgu konusunu oyuncak dioramaları ve model sayfası ayrıntılarıyla 2×2 ansiklopedi düzenine taşır.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HM022LJXwAABIO2.jpg" width="100%" alt="Açık kitapta bilim kurgu hikâye dioraması - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/Gdgtify/status/2076749503290351717)
- **Yayınlandı:** 13 Temmuz 2026
- **Diller:** en
...
#### No. 15: Sert kahraman karakter dönüş sayfası

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Aynı karakteri önden, yandan ve arkadan gösteren kısa ve sinematik bir karakter sayfası.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HCpAukXbwAAfxDK.jpg" width="100%" alt="Sert kahraman karakter dönüş sayfası - Image 1"></td>
</tr>
</table>

##### Detaylar

- **Yazar:** [Gowtham](https://x.com/GowthamCinemas)
- **Kaynak:** [Kaynak](https://x.com/GowthamCinemas/status/2029505882984501485)
...
#### No. 16: Lüks yolcu gemisi teknik infografiği

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Kurgusal bir gemiyi güverte kesitleri, özellikler, iç mekânlar ve performans göstergeleriyle sunar.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HH2fQ-KWIAMnfi9.jpg" width="100%" alt="Lüks yolcu gemisi teknik infografiği - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Minahil](https://x.com/Minahil42298354)
- **Kaynak:** [Kaynak](https://x.com/Minahil42298354/status/2052972122432016547)
...
#### No. 17: Kültürel açıklamalı resimli gezi haritaları

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Minyatür simgeler, yerel yemekler, yaban hayatı, istatistikler ve iki dilli etiketlerle zengin ülke haritaları kurar.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCDWXsAAl99J.jpg" width="100%" alt="Kültürel açıklamalı resimli gezi haritaları - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HIrFCAjW0AIZGnN.jpg" width="100%" alt="Kültürel açıklamalı resimli gezi haritaları - Image 2"></td>
</tr>
</table>
...
- **Yazar:** [Minahil](https://x.com/Minahil42298354)
- **Kaynak:** [Kaynak](https://x.com/Minahil42298354/status/2056672835125284972)
...
#### No. 18: Teknik dış giyim özellik sayfası

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Giysi görünümleri, malzeme yakın planları, modüler aksesuarlar ve teknik özellikleri tek tasarım sayfasında toplar.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HJUQCtgWcAQ8xE1.jpg" width="100%" alt="Teknik dış giyim özellik sayfası - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Minahil](https://x.com/Minahil42298354)
- **Kaynak:** [Kaynak](https://x.com/Minahil42298354/status/2059570046972670409)
...
### Karakterler, sinema ve görsel stiller (11)

Görsel yönetim ve görüntü diline odaklanan karakter, portre, moda, sinema karesi ve stil keşfi promptları.

<a id="prompt-13"></a>

#### No. 19: Fotogerçekçi gelecek mecha tasarımı

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Canlıları veya makineleri metalik, sinematik ve gerçekçi mecha tasarımlarına dönüştüren yeniden kullanılabilir bir stil tarifi.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HG-4lhZasAA35Gb.jpg" width="100%" alt="Fotogerçekçi gelecek mecha tasarımı - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/getkomusen/status/2049059361557746159)
...
#### No. 20: 1990'lar bağımsız yatak odası portresi

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Doğrudan flaş, kolaj duvarlar, film grenleri ve nostaljik bağımsız estetikle doğal bir lo-fi fotoğrafı yeniden kurar.
...
<table>
<tr>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_jxboAAadnf.jpg" width="100%" alt="1990'lar bağımsız yatak odası portresi - Image 1"></td>
<td width="50%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLV3_pxbkAA_BSc.jpg" width="100%" alt="1990'lar bağımsız yatak odası portresi - Image 2"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/jzaib4269/status/2068691563522458015)
...
#### No. 21: Notion tarzı tek renk avatar
...
Kendinden emin tek kalınlıkta çizgiler ve seçici siyah dolgularla sıradan ikon görünümünden uzak kişilikli bir vektör portre oluşturur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/G_SnZVIWkAAoaF9.jpg" width="100%" alt="Notion tarzı tek renk avatar - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [AmirMušić](https://x.com/AmirMushich)
- **Kaynak:** [Kaynak](https://x.com/AmirMushich/status/2014418990018261493)
...
#### No. 22: Geometrik mozaik plan estetiğinde portre

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Birbirine geçen çokgen parçaları, teknik yapı çizgileri ve cesur modernist renk alanlarıyla çağdaş bir portre oluşturun.
...
<table>
<tr>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkkCXkAAHuEx.jpg" width="100%" alt="Geometrik mozaik plan estetiğinde portre - Image 1"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrkwYXkAAhA3H.jpg" width="100%" alt="Geometrik mozaik plan estetiğinde portre - Image 2"></td>
<td width="33%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HMmrk35W8AAHq5V.jpg" width="100%" alt="Geometrik mozaik plan estetiğinde portre - Image 3"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/HustleXR/status/2074377759674057125)
...
#### No. 23: Rembrandt ışıklı monokrom moda portresi

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Heykelsi Rembrandt ışığı, kontrollü film grenleri ve sade lüks editoryal bitişle içe dönük bir siyah-beyaz portre yönetin.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNPQqFIa0AAGQpe.jpg" width="100%" alt="Rembrandt ışıklı monokrom moda portresi - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Aijaz](https://x.com/iamsofiaijaz)
- **Kaynak:** [Kaynak](https://x.com/iamsofiaijaz/status/2077233281729536050)
- **Yayınlandı:** 15 Temmuz 2026
- **Diller:** en
...
#### No. 24: On üç referansı birleştiren moda sahnesi
...
Model, otomobil, kıyafet, aksesuar, hayvan ve küçük nesneleri tutarlı bir stüdyo karesinde birleştiren çoklu referans testi.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/GzYYDUoWIAA8x0l.jpg" width="100%" alt="On üç referansı birleştiren moda sahnesi - Image 1"></td>
</tr>
</table>

##### Detaylar

- **Yazar:** [@MrDavids1](https://x.com/MrDavids1)
- **Kaynak:** [Kaynak](https://x.com/MrDavids1/status/1960783672665128970)
...
#### No. 25: Kimliği korunan rüzgârlı monokrom yakın plan
...
Kadraj, kontrast, bakış, gren ve saç hareketini sınırlarken yüz kimliğini koruyan kısa referans portresi.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HNv0bCQboAAUgHA.jpg" width="100%" alt="Kimliği korunan rüzgârlı monokrom yakın plan - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/dreamydigiarts/status/2079884159447707994)
...
#### No. 26: Yeni örnek: □A Image 4K double-exposure style photo editing poster featuring
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOM52w7XAAA_y1X.jpg" width="100%" alt="Yeni örnek: □A Image 4K double-exposure style photo editing poster featuring - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/JamilAI55/status/2081571082415292841)
...
#### No. 28: Puantiye desenli sokak stili portresi

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Kaynağa dayalı bu Nano Banana moda portresi, tam boy kadrajda kıyafet geometrisini, el yerleşimini, aksesuar ölçeğini ve doğal gün ışığını tutarlı kılar.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYvaYAAysql.jpg" width="100%" alt="Puantiye desenli sokak stili portresi - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmY_agAE15N0.jpg" width="100%" alt="Puantiye desenli sokak stili portresi - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmX9aQAA-UO5.jpg" width="100%" alt="Puantiye desenli sokak stili portresi - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOuHmYRaMAI1inR.jpg" width="100%" alt="Puantiye desenli sokak stili portresi - Image 4"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/woleswoosh/status/2084247918882791849)
- **Yayınlandı:** 3 Ağustos 2026
- **Diller:** en
...
#### No. 29: Örtüşmesiz bir editoryal başlık için korunan metin alanı

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Başlık alanını koruyan, özneyi tipografiden ayıran ve her kelimeyi okunaklı tutan kaynaklı bir Nano Banana yerleşim iş akışı.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOwMMqKasAAcPFn.jpg" width="100%" alt="Örtüşmesiz bir editoryal başlık için korunan metin alanı - Image 1"></td>
</tr>
</table>

##### Detaylar

- **Yazar:** [Tim Start](https://x.com/timstartai)
- **Kaynak:** [Kaynak](https://x.com/timstartai/status/2084054142671266137)
...
Mekânın fikri taşıdığı çevre, mimari, manzara, konsept sanat ve dünya kurma promptları.

**Community · Öne çıkan promptlar**

- [Venedik'te gerçeküstü dev figür](#prompt-21)

<a id="prompt-20"></a>

#### No. 30: Altın saatte dağ çayırı

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Kıvrılan patika, kır çiçekleri, tek ağaç, uzaktaki hayvanlar ve parlayan dağlarla katmanlı bir manzara oluşturur.
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HLvkD0RbgAAWXzv.jpg" width="100%" alt="Altın saatte dağ çayırı - Image 1"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/nxnusratul/status/2070499219476230359)
...
#### No. 31: Yeni örnek: Battle 🥊 4 Models 1 Models In Image Order
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCTWYAA6hit.jpg" width="100%" alt="Yeni örnek: Battle 🥊 4 Models 1 Models In Image Order - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCQWcAAiPAY.jpg" width="100%" alt="Yeni örnek: Battle 🥊 4 Models 1 Models In Image Order - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCbW8AEompx.jpg" width="100%" alt="Yeni örnek: Battle 🥊 4 Models 1 Models In Image Order - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HOMkiCYWkAIoV4t.jpg" width="100%" alt="Yeni örnek: Battle 🥊 4 Models 1 Models In Image Order - Image 4"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/LANDCASTER_92/status/2081547625032040952)
- **Yayınlandı:** 27 Temmuz 2026
- **Diller:** en
...
### Karşılaştırmalar ve model kıyaslamaları (2)

Prompt takibi, düzenleme davranışı, tutarlılık, tipografi ve görsel kaliteyi ölçen kontrollü testler.

<a id="prompt-6"></a>

#### No. 32: Gemini 2.5 ve 3.1 editoryal portre karşılaştırması

![Language-EN](https://img.shields.io/badge/Language-EN-blue)

##### Açıklama

Aynı portre briefini Gemini 2.5 Flash Image ve Gemini 3.1 Flash Image ile uygulayarak sonuçları karşılaştırır.
...
<table>
<tr>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nBakAAxshH.jpg" width="100%" alt="Gemini 2.5 ve 3.1 editoryal portre karşılaştırması - Image 1"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK571nkbkAAJ7Wu.jpg" width="100%" alt="Gemini 2.5 ve 3.1 editoryal portre karşılaştırması - Image 2"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK5792CaEAAs9YT.jpg" width="100%" alt="Gemini 2.5 ve 3.1 editoryal portre karşılaştırması - Image 3"></td>
<td width="25%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HK58Db6a4AAws5c.jpg" width="100%" alt="Gemini 2.5 ve 3.1 editoryal portre karşılaştırması - Image 4"></td>
</tr>
</table>
...
- **Kaynak:** [Kaynak](https://x.com/VIBEQUIRKLABS/status/2066727367410876908)
...
#### No. 33: Yeni örnek: 2x2 grid, 16:9, do this for 4 famous days
...
<table>
<tr>
<td width="100%" valign="top" align="center"><img src="https://pbs.twimg.com/media/HN6RCfRWsAAhCWX.jpg" width="100%" alt="Yeni örnek: 2x2 grid, 16:9, do this for 4 famous days - Image 1"></td>
</tr>
</table>
...
- **Yazar:** [Gadgetify](https://x.com/Gdgtify)
- **Kaynak:** [Kaynak](https://x.com/Gdgtify/status/2081286397949001917)
- **Yayınlandı:** 26 Temmuz 2026
- **Diller:** en
...
Belgelenmiş bir Nano Banana iş akışı mı buldunuz? Özgün promptu, sonucu, üreticiyi ve kaynağı GitHub Issues üzerinden gönderin.

### GitHub Issue

1. [**Yeni prompt gönder**](https://github.com/imaginevid-ai/Awesome-nano-banana-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. Formu prompt, görseller ve kaynak bilgileriyle doldurun
3. Gönderin ve maintainer incelemesini bekleyin
4. Onaylanan issue yerel depo verileriyle eşitlenebilir
5. Prompt bir sonraki README üretiminden sonra görünür

**Not:** Her gönderi yayımlanmadan önce kaynak, model kanıtı, yararlılık ve tekrar açısından incelenir.

Tüm kurallar için [CONTRIBUTING.md](docs/CONTRIBUTING.md) dosyasına bakın.

---

## Lisans

[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) lisansı ile sunulur.
...
<details>
<summary>Topluluk üreticileri (24)</summary>
...
**[Star geçmişi](https://star-history.com/#imaginevid-ai/Awesome-nano-banana-prompts-and-skills&Date)**
...
<sub>Bu README otomatik oluşturuldu. Son güncelleme: 2026-08-17T12:23:11.453Z</sub>
